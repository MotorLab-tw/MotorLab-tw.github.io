...
GUIDES = [
    ...
    #             = 效能對比「15 款馬達同條件實測」系列起始章
    {
        ...
        "i18n": {
            "zh": {
                "title": "馬達越磨越快,其實在磨壞?12 小時實測:磨合何時該停 | MotorLab",
                ...
                "breadcrumb": "磨合何時該停",
                "h1_for_ld": "轉速越磨越快,其實是在磨壞?12 小時過磨實驗拆穿磨合最貴的誤會",
            },
            "en": {
                "title": "Motor Faster the More You Grind? When to Stop Break-In: a 12-Hour Test | MotorLab",
                ...
                "h1_for_ld": "RPM Keeps Rising — Improving, or Breaking? The 12-Hour Over-Break-In Test",
            },
            "ja": {
                "title": "ミニ四駆モーター、磨くほど速くなるのは劣化のサイン?12 時間実測 | MotorLab",
                ...
                "keywords": "ミニ四駆 慣らし 時間, モーター 慣らし どのくらい, 慣らし やりすぎ, 過慣らし, スマート慣らし, タミヤ 15 機種 実測, MotorLab",
                "breadcrumb": "慣らしの止めどき",
                "h1_for_ld": "磨くほど速くなる=壊れてる?12 時間の過慣らし実験が暴く、慣らし最大の誤解",
            },
        },
    },
]
