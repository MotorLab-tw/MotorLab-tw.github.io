...
MANUAL = {
    ...
    "i18n": {
        "zh": {
            ...
            "description": "MotorLab Mini 4WD® 馬達磨合機完整使用手冊 — 連線、馬達特性量測、磨合兩種模式、AI 智慧磨合、馬達測試、歷史紀錄、全球磨合資料庫、AI 健康管理、軸承/電刷測試、田宮馬達規格、系統設定、安全保護、WiFi 重設與常見問題。對應韌體 v3.12.1。",
            "keywords": "MotorLab 使用手冊, 馬達磨合機操作, 馬達磨合機說明書, MotorLab 教學, 馬達磨合機設定",
            "breadcrumb": "使用者手冊",
            "eyebrow": "Docs · 使用者手冊",
            "h1": "MotorLab 使用者手冊",
            "lead": "Mini 4WD® 馬達磨合機完整操作說明。對應韌體 v3.12.1。功能隨版本更新,新版可能多出未列選項。",
            "toc_label": "目錄",
            "fw_note": "本手冊適用 MotorLab v3.12.1 韌體(2026-09-13)。",
        },
        "en": {
            "title": "MotorLab User Manual: Motor Break-in Machine Guide | MotorLab",
            "description": "Complete user manual for the MotorLab Mini 4WD® motor break-in machine — connection, motor characterization, two-mode break-in, AI smart break-in, testing, history records, global database, AI health management, bearing/brush tests, Tamiya motor specs, system settings, safety, WiFi reset and FAQ. For firmware v3.12.1.",
            ...
            "lead": "Complete operating guide for the Mini 4WD® motor break-in machine. For firmware v3.12.1. Features evolve with each release; newer firmware may add options not listed here.",
            "toc_label": "Contents",
            "fw_note": "This manual applies to MotorLab firmware v3.12.1 (2026-09-13).",
        },
        "ja": {
            "title": "MotorLab ユーザーマニュアル:モーター慣らし機操作ガイド | MotorLab",
            "description": "MotorLab Mini 4WD® モーター慣らし機の完全ユーザーマニュアル — 接続、モーター特性測定、慣らし 2 モード、AI スマート慣らし、テスト、履歴記録、グローバルデータ庫、AI 健康管理、ベアリング/ブラシ測定、タミヤモーター規格、システム設定、安全保護、WiFi リセット、FAQ。ファームウェア v3.12.1 対応。",
            ...
            "lead": "Mini 4WD® モーター慣らし機の完全操作ガイド。ファームウェア v3.12.1 対応。機能はバージョンごとに更新され、新版では未記載の項目が増える場合があります。",
            "toc_label": "目次",
            "fw_note": "本マニュアルは MotorLab ファームウェア v3.12.1（2026-09-13）に対応します。",
        },
    },
    "sections": {
        "zh": [
            ...
            {"id": "records", "t": "十、歷史紀錄", "html": (
                "<p class='manual-intro'>自動儲存每次磨合完整資料,最多 <b>50 筆</b>。</p><p>每筆顯示名稱 / 開始時間 / 時長 / 模式 / 結束原因 / 最大轉速 / 平均轉速 / 穩定電流。</p><table class='manual-table'><thead><tr><th>按鈕</th><th>用途</th></tr></thead><tbody><tr><td>檢視</td><td>看每一階段數據(多趟紀錄逐趟列出各階段;含暫停設定與實際等待秒數)</td></tr><tr><td>套用</td><td>把配方(<b>電壓／轉速模式</b>、趟數、各趟 10 階段參數,電壓表與轉速表都還原、含暫停設定)一鍵套回磨合頁,磨合頁自動切到該紀錄的模式;舊單趟紀錄套用後趟數=1</td></tr><tr><td>匯出</td><td>下載 JSON(可再匯入)或 CSV(Excel 開)</td></tr><tr><td>刪除</td><td>移除(不可復原)</td></tr></tbody></table><ul><li><b>容量滿(50 筆)</b>:管理中可選「自動覆寫」(啟動時刪最舊)或「不覆寫」(預設,啟動被擋需手動清)。</li><li><b>匯入</b>:選之前匯出的 JSON(id 重複會覆蓋)。只收 JSON。每個匯出檔帶<b>簽章驗證</b>:同台 / 同批機器可互通,竄改或非本批機器的檔會被拒絕;改檔名不影響(驗的是內容)。</li><li><b>檔名</b>:<code>motorlab_&lt;日期&gt;_&lt;時間&gt;_&lt;型號&gt;[_&lt;備註&gt;]</code>,採磨合開始時間 → 同筆重複匯出檔名一致。</li><li>韌體更新 / WiFi 重設<b>都不會清紀錄</b>。</li></ul>"
            )},
