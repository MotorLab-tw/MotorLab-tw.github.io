...
FAQ = {
    "zh": [
        ...
        {
            "q": "為什麼即時遙測對馬達磨合很重要?",
            "a": "即時遙測讓磨合過程從「定時跑完就好」變成「依實際狀態收斂」。MotorLab 透過即時電流量測偵測電刷接觸不穩與軸承衰減(τ),並在磨到位時自動停止。",
        },
        {
            "q": "什麼是 Gen5 馬達調校系統?",
    ...
    "en": [
        ...
        },
        {
            ...
            "a": "Real-time telemetry turns break-in from 'just run the timer' into 'converge on actual motor state'. MotorLab uses real-time current measurement to detect brush-contact instability and bearing tau decay, and it stops automatically only once the motor is there.",
        },
        {
    ...
    "ja": [
        ...
        },
        {
            ...
            "a": "リアルタイムテレメトリーにより、慣らしが「タイマーで終わらせる」から「実際のモーター状態に収束させる」へ進化します。MotorLab はリアルタイム電流測定でブラシ接触の不安定とベアリング τ 減衰を検出し、仕上がってはじめて自動停止します。",
        },
        {
            "q": "Gen5 モーター調整システムとは?",
    ...
    # ---------- g20:AI 智慧磨合前後實測(benchmarks hub)----------
    {
        ...
        "i18n": {
            "zh": {
                ...
                "description": "AI 智慧磨合到底有沒有效?一顆全新 Mach-Dash PRO,磨前量一次 → AI 自動磨到停 → 等到溫度回到磨前再量(同溫對照)。結果:同電壓轉速 +2.7%、帶動更省力、扭力持平(不傷磁鐵)。全新品內耗微升是正常,判讀看轉速上升與磨合曲線下降。",
...
MANUAL = {
    ...
    "i18n": {
        "zh": {
            ...
            "description": "MotorLab Mini 4WD® 馬達磨合機完整使用手冊 — 連線、馬達特性量測、磨合兩種模式、AI 智慧磨合、馬達測試、歷史紀錄、全球磨合資料庫、AI 健康管理、軸承/電刷測試、田宮馬達規格、系統設定、安全保護、WiFi 重設與常見問題。對應韌體 v3.12.2。",
            "keywords": "MotorLab 使用手冊, 馬達磨合機操作, 馬達磨合機說明書, MotorLab 教學, 馬達磨合機設定",
            "breadcrumb": "使用者手冊",
            "eyebrow": "Docs · 使用者手冊",
            "h1": "MotorLab 使用者手冊",
            "lead": "Mini 4WD® 馬達磨合機完整操作說明。對應韌體 v3.12.2。功能隨版本更新,新版可能多出未列選項。",
            "toc_label": "目錄",
            "fw_note": "本手冊適用 MotorLab v3.12.2 韌體(2026-09-13)。",
        },
        "en": {
            "title": "MotorLab User Manual: Motor Break-in Machine Guide | MotorLab",
            "description": "Complete user manual for the MotorLab Mini 4WD® motor break-in machine — connection, motor characterization, two-mode break-in, AI smart break-in, testing, history records, global database, AI health management, bearing/brush tests, Tamiya motor specs, system settings, safety, WiFi reset and FAQ. For firmware v3.12.2.",
            ...
            "lead": "Complete operating guide for the Mini 4WD® motor break-in machine. For firmware v3.12.2. Features evolve with each release; newer firmware may add options not listed here.",
            "toc_label": "Contents",
            "fw_note": "This manual applies to MotorLab firmware v3.12.2 (2026-09-13).",
        },
        "ja": {
            "title": "MotorLab ユーザーマニュアル:モーター慣らし機操作ガイド | MotorLab",
            "description": "MotorLab Mini 4WD® モーター慣らし機の完全ユーザーマニュアル — 接続、モーター特性測定、慣らし 2 モード、AI スマート慣らし、テスト、履歴記録、グローバルデータ庫、AI 健康管理、ベアリング/ブラシ測定、タミヤモーター規格、システム設定、安全保護、WiFi リセット、FAQ。ファームウェア v3.12.2 対応。",
            ...
            "lead": "Mini 4WD® モーター慣らし機の完全操作ガイド。ファームウェア v3.12.2 対応。機能はバージョンごとに更新され、新版では未記載の項目が増える場合があります。",
            "toc_label": "目次",
            "fw_note": "本マニュアルは MotorLab ファームウェア v3.12.2（2026-09-13）に対応します。",
        },
    },
    "sections": {
        "zh": [
            {"id": "precautions", "t": "〇、使用前必讀・安全須知", "html": (
                "<div class='manual-note'><b>首次使用前請詳閱本章。未依安全須知使用所造成之人身傷害、財物損失或機器損害,使用者須自負責任,亦不予保固。</b></div><h3>🔴 電源安全</h3><ul><li>本機須用 <b>DC 5V／6A 以上</b>、<b>具安規認證</b>的電源供應器。</li><li><b>使用規格不符的電源(電壓過高、劣質、無安規、來路不明或改裝)將導致機器損壞,並有引發火災的危險;因此造成的故障或損害不予保固。</b></li><li>勿在電源線材或接頭破損、發燙、有異味時繼續使用。</li></ul><h3>🔴 運轉安全(馬達高速旋轉)</h3><ul><li><b>馬達運轉中,嚴禁用手、工具或任何物體觸碰轉軸、齒輪或反射盤</b>——高速旋轉會造成割傷、捲入、飛甩傷害。</li><li>運轉前確認馬達<b>牢固裝在治具上</b>,未固定的馬達高速旋轉可能飛脫。</li><li><b>臉部、頭髮、鬆散衣物、飾品</b>勿靠近運轉中的馬達。</li><li>馬達與周邊零件運轉後會<b>發熱燙手</b>,停機後勿立即徒手觸摸。</li><li>運轉中若有異音、異味、冒煙、火花,<b>立即切斷電源</b>並檢查。</li></ul><h3>🔴 環境安全</h3><ul><li><b>本機不防水</b>:使用與存放<b>遠離水源、潮濕、雨淋</b>;勿讓液體(水、油、飲料)潑濺到機身或電路。</li><li>放置於<b>平穩、堅固、耐熱、不可燃</b>的桌面;勿在鋪毯、紙張、易燃物上運作。</li><li>保持四周<b>通風散熱</b>,勿覆蓋機身散熱孔;勿在密閉高溫環境長時間運作。</li><li>遠離火源、熱源、陽光直曬。</li></ul><h3>🔴 操作安全</h3><ul><li><b>兒童請在成人監護下使用</b>;零件與馬達含小物與尖銳邊緣,勿讓幼童單獨接觸。</li><li>勿自行拆解、改裝機器或電路;勿以本機驅動非指定的馬達或負載。</li><li><b>端子僅供連接馬達</b>,勿接電池、電源或其他負載,以免短路損壞。</li><li>長時間不使用時<b>拔除電源</b>。</li></ul><h3>量測重複性(同一台機器、同一顆馬達、跨場次)</h3><table class='manual-table'><thead><tr><th>項目</th><th>重複性</th></tr></thead><tbody><tr><td>磁力類</td><td>&#177;5%</td></tr><tr><td>內耗類</td><td>&#177;3%</td></tr><tr><td>轉速</td><td>&#177;1%</td></tr><tr><td>扭力預測</td><td>&#177;10%</td></tr><tr><td>軸承完全靜止時間</td><td>&#177;10%(約 &#177;0.2 秒)</td></tr><tr><td>電刷落點圖</td><td>不設絕對規格</td></tr></tbody></table><div class='manual-note'><b>變化沒超過上表範圍,就先當量測散布。</b></div><h3>⚠ 量測數據注意</h3><ul><li>本機數據<b>僅供同一台機器上的前後對照與相對比較</b>;不同設備／儀器數據有系統性差異,<b>勿與他人或市售數據直接比較</b>。</li><li>量測時請勿使用<b>導電型磨合油</b>(會使讀數失真,詳見「五、馬達磨合」)。</li><li><b>量測時的溫度變化,會讓量測數據產生一定程度的變異,因此各量測數據僅供參考。</b>馬達的磁力、線圈電阻、電刷接觸、軸承油的黏度<b>都會隨溫度改變</b>,而且各自的方向與幅度不同。機器已盡量把量測條件拉到一致,但<b>無法完全消除溫度的影響</b>。因此各量測結果頁都會標示<b>當次的「量測溫度」</b>——判讀數據、尤其是<b>跨日或跨季</b>比較同一顆馬達時,請一併看溫度;溫度差越大,數字的可比性越低。</li></ul><p class='manual-intro'>本機內建高溫保護、過流／短路／卡轉／離治具偵測、緩啟動緩停止等多重自動防護(詳見「十七、安全與保護」),但這些是輔助,<b>不能取代使用者的安全操作與看管</b>。</p>"
            )},
            ...
            {"id": "charexp", "t": "四、馬達特性量測", "html": (
                "<p class='manual-intro'>全自動量出馬達的特性參數與損耗,<b>給參考數據</b>——同型號馬達互相比較、自己判斷。系統自動連續量測,過程溫和,適合全新未磨合馬達。<br><b>量測誤差:&#177;5%</b></p><p><b>操作</b>:首頁 →「馬達特性量測」→ 選方向(預設正轉)+ 選<b>馬達型號</b>(田宮 15 款＋「Other」)+ 填<b>備註</b>(選填,40 字以內)→「開始量測」→ 全程自動,過程中請勿觸碰馬達 → 完成顯示數據表並<b>自動存入量測紀錄</b>。</p><div class='manual-note'><b>自動準備</b>:按下開始後,系統必要時會先自動準備(狀態顯示「準備中」)再進入量測,讓每次量測的條件一致,過程不需要任何手動操作。<b>趟與趟之間也會自動準備</b>,確保 3 趟是在同樣條件下量的——這是「3 趟一致性」能反映馬達本身的前提。環境條件不適合時會提示「<b>數據僅供參考</b>」,測試照常進行。扭力預測與健康管理的量測同樣適用(扭力預測的畫面較精簡,只顯示「數據收集中」與進度條,不另列階段名)。<b>自動準備的過程也計入進度條</b>——進度條一開始就會前進,不是當機。</div><p><b>要跑多久</b>:含自動準備全程約 <b>6~7 分鐘</b>。畫面全程顯示「數據收集中」與進度條;分段之間會短暫停轉並顯示「準備下一段…」,<b>不是故障</b>。中途請勿觸碰馬達。</p><p><b>怎麼看數據(表內每項都標了方向)</b>:</p><ul><li><b>★ I0(無載電流)</b>:同轉速下<b>越低越好</b>——三個指標裡重複性最佳。</li><li><b>★ Km(品質因數)/ ★ T_loss(損耗轉矩)</b>:輔助指標(Km 越高越好、T_loss 越低越好)。</li><li><b>量測溫度</b>:量測當下的機器溫度,供核對用(磁力類數值已由系統自動校正,不同天量的結果可直接比較)。</li><li><b>起轉電壓</b>:僅參考——單次隨機性大,適合當同一顆馬達的長期健康對照(日後明顯升高=軸承／電刷劣化警訊)。</li><li><b>損耗擬合 R²</b>:資料品質指標(越接近 1 這筆數據越可信)。</li><li><b>3 趟一致性</b>:各趟 I0 的最大差異,<b>純數值呈現</b>——多少算大要看馬達狀態,沒有一條放諸四海的線。自己判讀:數值明顯偏大時先檢查馬達是否夾緊、治具與感測器有無鬆動;<b>未磨合的全新馬達天生偏大</b>是正常的(它在量測當下還在變化),磨合完成後再量會明顯收斂。同一顆馬達前後對照最有參考價值。</li></ul><p><b>量測紀錄</b>:量測頁 →「量測紀錄」。每次成功量測自動儲存(含全部指標與各轉速點資料),最多 <b>50 筆</b>,滿了自動刪除最舊;可檢視詳情、可刪除。</p><p><b>建議用法</b>:</p><ul><li>磨合後<b>再測同一顆</b>對照:損耗類應下降(磨合有效);Ke／R 應幾乎不變。</li><li>磁力類數值機器已做過溫度修正,跨溫比較<b>較為可靠</b>(但仍非完全免疫);<b>損耗類(I0／T_loss)</b>沒有修正,務必在<b>相近溫度</b>下比較(低溫時油較稠、數值自然偏高)。馬達剛裝上機器或冷機重啟後,第一次量測數據可能偏高,以第二次起為準。</li></ul><div class='manual-note'><b>注意</b>:量測失敗(馬達未起轉／鎖定逾時／過流)會顯示原因,重試即可。若反覆失敗或待機時轉速顯示不為 0,請檢查轉速感測器與反射盤的對位。</div>"
            )},
            {"id": "breakin", "t": "五、馬達磨合(兩種模式)", "html": (
                "<p class='manual-intro'>低速長時間運轉,讓電刷與整流子貼合到最佳接觸。磨合頁最上方有<b>兩個模式按鈕</b>(運轉中不可切換)。</p><div class='manual-note'><b>⚠ 磨合前請勿在軸承上油。</b>油一旦沾到電刷或整流子,量測數據會失準,摩擦力變小也會讓磨合時間大幅拉長。正確順序是:<b>磨合完成後</b>再為軸承上油。(AI 智慧磨合同樣適用)</div><table class='manual-table'><thead><tr><th>模式</th><th>適合</th><th>一句話</th></tr></thead><tbody><tr><td><b>電壓模式</b></td><td>有自己配方的玩家</td><td>各階段固定電壓運轉(傳統方式)</td></tr><tr><td><b>轉速模式 (Beta)</b></td><td>想以轉速為基準的玩家</td><td>各階段自動控速在設定轉速,電壓穩定即自動換階</td></tr></tbody></table><div class='manual-note'>想「一鍵全自動、磨好自動停」的玩家,請用首頁的獨立功能「<b>AI 智慧磨合</b>」(Pro,詳見「六、AI 智慧磨合」)。</div><h3>電壓模式</h3><p>首頁 →「馬達磨合程式」→ 選<b>馬達型號</b>(16 款)+ 填<b>備註</b>(40 字以內)→ 選<b>判停標準</b>(純時間限制=各階段跑滿設定時間;智慧穩定=電流提前穩定就換階,時間為上限)→ 選<b>磨合趟數</b>(1~6,預設 1)→ 逐趟確認 10 階段參數(多趟用分頁籤切換趟;直接點數字欄修改)→「啟動」。</p><ul><li>每階段可設:電壓(0.6~4.0V,<b>0=跳過</b>)/ 方向 / 磨合秒(10~600,預設 60)/ 冷卻秒(10~600,預設 60)/ <b>暫停</b>(ON／OFF,預設 OFF)/ 穩定電流容差(2~50mA)。</li><li>多趟可按「<b>本趟複製到之後所有趟</b>」快速填表;趟數旁即時顯示<b>預估總時長</b>。</li><li>輸入超出範圍會自動改為上下限並閃光提示。</li></ul><h3>範例:新馬達的「逐趟縮容差」磨合 SOP</h3><p>新馬達的碳刷與整流子尚未整形,建議用這套流程:<b>容差由寬到窄、一趟縮一格,讓馬達自己決定每階段要磨多久</b>。</p><p><b>前置</b>:判停標準選「<b>智慧穩定</b>」(此手法靠「電流穩定就提前換階」運作;純時間限制下無效)。電壓照你的配方即可,範例用 1.0V。</p><table class='manual-table'><thead><tr><th>趟</th><th>穩定電流容差</th><th>磨合秒(當上限用,設長一點)</th></tr></thead><tbody><tr><td>1</td><td>50 mA</td><td>60</td></tr><tr><td>2</td><td>30 mA</td><td>90</td></tr><tr><td>3</td><td>20 mA</td><td>120</td></tr><tr><td>4</td><td>10 mA</td><td>180</td></tr><tr><td>5</td><td>5 mA</td><td>240</td></tr></tbody></table><p>設定方式:趟 1 各階段容差填 50 → 分頁籤切到趟 2 填 30 → 依此類推(同趟內可用「本趟複製」快速填表)。</p><p><b>怎麼讀(只要看一件事:換階是提早、還是跑滿時間)</b></p><table class='manual-table'><thead><tr><th>你看到的</th><th>意義</th><th>下一步</th></tr></thead><tbody><tr><td>階段<b>提早換階</b>(沒跑滿磨合秒)</td><td>這個容差下已穩定</td><td>下一趟縮一格</td></tr><tr><td>階段<b>幾乎都跑滿時間</b>才換</td><td>還沒穩到這個容差</td><td>下一趟<b>用同一個容差再跑一次</b>,不要急著縮</td></tr><tr><td>縮到最小容差仍大多提早換階</td><td><b>磨合完成</b></td><td>收工,接「標準磨合流程」的磨後量測</td></tr><tr><td><b>同一個容差連續兩趟都跑滿時間</b></td><td><b>這顆的水準就到這裡</b></td><td><b>到此為止,不要再縮</b></td></tr></tbody></table><div class='manual-note'><b>&#9888; 最後一列最重要</b>:每顆馬達能達到的穩定程度天生不同,「縮不下去」不是沒磨好,是它的底就在那裡——<b>再磨下去沒有幫助,反而增加磨耗</b>。</div><p>小叮嚀:冷卻秒維持預設(60)以上,趟與趟之間讓馬達確實降溫——溫度變動大時,換階會顯得偏慢(頁面上的溫度可供核對)。想全自動做完這整套的 Pro 玩家,用首頁「AI 智慧磨合」即可。</p><h3>轉速模式 (Beta)</h3><p>與電壓模式相同的階段表,但第一欄改為<b>目標轉速</b>(6000~30000,每 1000 一階,<b>0=跳過</b>)——機器自動調整電壓把馬達鎖定在該轉速。</p><ul><li><b>判停標準</b>(嚴格 / 標準 / 寬鬆):馬達在該轉速下驅動電壓穩定即視為磨順、提前換階;磨合秒為上限。嚴格=要更穩才過關(磨得較透);寬鬆=較快換階(全新馬達一直換不了階可改寬鬆)。</li><li>每階段以<b>緩慢爬升</b>進場,接近目標後才開始鎖定與計時——目標轉速越高、進場時間越長,屬正常程序。</li><li>階段結果欄顯示<b>穩定電壓</b>;推不到目標轉速會以安全上限電壓跑滿時間並標「<b>未達標</b>」(通常代表目標轉速訂太高,或馬達 / 治具異常)。</li><li>方向、時間、趟數、複製等操作皆與電壓模式相同。</li></ul><h3>共同行為</h3><p>每階段流程:緩啟動 → 運轉中 → 緩停止 → 冷卻中 → 下一階段;跑完一趟自動接下一趟(顯示「第 x/y 趟 · 階段 c」)。全部完成 → 嗶 3 聲 → 自動存入歷史紀錄(電壓 / 轉速模式,含每趟每階段結果)。</p><p><b>運轉中可按</b>:</p><table class='manual-table'><thead><tr><th>按鈕</th><th>行為</th></tr></thead><tbody><tr><td>暫停運轉</td><td>緩停後<b>暫停</b>,按鈕變為「<b>恢復運轉</b>」;再按即從<b>斷點接續</b>——階段已跑的秒數保留不重算、冷卻倒數接續。暫停無時限;<b>暫停期間其餘按鈕全部鎖定,只有「恢復運轉」可按</b></td></tr><tr><td>停止</td><td>緩停後結束,紀錄標「使用者中止」</td></tr><tr><td>回首頁</td><td>切回首頁,磨合<b>背景繼續跑</b></td></tr></tbody></table><div class='manual-note'><b>關於暫停</b>:暫停期間馬達停轉降溫,恢復續磨等同在該階段插入一次額外冷卻,對磨合無害;恢復後該階段的「穩定判定」會重新收集(避免冷熱狀態混判)。<b>斷電不保留暫停進度</b>——中途斷電視同中止。(「歸零」須待機時才可按,清除上一次運轉的顯示紀錄。)</div><div class='manual-note'><b>階段暫停(階段表的「暫停」欄)</b>:設 ON 的階段在<b>冷卻結束後不會自動進下一階段</b>,機器嗶一長聲後停住等你,畫面提示「已依設定在第 x 趟階段 c 之後暫停」,按「<b>恢復運轉</b>」才接著跑下一階段。用途是趟與趟之間(或某階段之後)先檢查馬達再繼續。等待沒有時間限制;等待中其餘按鈕鎖定,只留「恢復運轉」與「停止」。最後一個階段設 ON 沒有作用(之後已無階段)。此設定與「暫停運轉」按鈕互不影響,兩者可並用;斷電同樣不保留。每階段的暫停設定與<b>實際等待秒數</b>會一併寫進該次歷史紀錄(「檢視」的暫停欄、CSV 的 pause／hold_sec 欄);「套用」配方時暫停設定也會一起套回。</div><div class='manual-note'><b>注意</b>:運轉中所有設定鎖定(暫停中亦同);勿中途斷電(資料遺失);高溫會自動停止並存檔;想快速驗機就把每階段時間改短。即時數據多一格 <b>KV(rpm/V)</b>＝目前轉速除以馬達電壓,供快速對比馬達狀態;另有「<b>本階段運轉 x / y 秒</b>」直接顯示本階段的磨合進度——<b>只累計全速運轉的秒數</b>(緩啟動／緩停止／暫停都不計入),到 y 秒即換階。</div><div class='manual-note'><b>重要:測量／磨合請勿使用「導電潤滑油」。</b>市面標榜「導電」的磨合油(含導電碳粉)加入後轉速瞬升、電壓瞬降,那<b>不是真的磨好,而是碳粉暫時導電的假象</b>。本機所有判定(穩定電流 / 轉速 / 內阻)量測的是電刷與整流子的<b>真實接觸狀態</b>,導電油會使讀數失真偏樂觀(這類油品說明書自己也註明「洗淨後才穩定、才會更好轉」),油一洗掉就打回原形。正確做法:全程不用這類油;若已使用,請徹底洗淨後再上機量測。一般軸承微量潤滑不受影響,此警告僅針對「導電型磨合油」。</div>"
            )},
            {"id": "smartbreakin", "t": "六、AI 智慧磨合(beta)(Pro)", "html": (
                "<p class='manual-intro'>一鍵全自動磨合:系統自己磨、自己量,<b>一場磨到這顆的最佳狀態、自動停止</b>——不必分多場、不必自己判斷要磨幾次。</p><p><b>操作</b>:首頁 →「AI 智慧磨合(beta)」→ 選<b>馬達型號</b>＋填<b>備註</b>(選填,40 字以內)＋選<b>時間上限</b>(磨到完成為止／2h／3h／4h)→「啟動」。<b>其餘全自動</b>,磨好會自動停止並嗶聲提示。</p><div class='manual-note'><b>底盤</b>:與「系統設定 → 馬達與底盤」是同一個設定,兩處下拉互相同步(見「十六、系統設定」)。不同底盤的電池極性接法不同,馬達在車上的正轉方向也不同;底盤選對,磨合時的正反轉才與實車一致。型號與底盤軸型不符時(例如 PRO 雙軸馬達配單軸底盤)啟動鈕會變灰並提示到系統設定重選底盤;系統不會自行改選。</div><div class='manual-note'><b>目前僅支援碳刷類 7 款</b>(Hyper-Dash PRO／Mach-Dash PRO／Hyper-Dash 3／Sprint-Dash／Power-Dash／Ultra-Dash／Plasma-Dash)。<b>銅刷類 8 款暫不支援</b>智慧磨合,選到時啟動鈕會變灰並在畫面說明;這 8 款請改用「馬達磨合程式」。其他功能(特性量測、磨合程式、測試)仍支援全 15 款。</div><div class='manual-note'><b>時間</b>:多數馬達約 <b>1.5~2 小時</b>。時間上限建議留在預設的 3h,或選「磨到完成為止」。選 2h 有機會在磨完之前就到上限,會顯示「時間上限已到,尚未確認完成」;<b>此時再啟動是從頭重跑一場完整磨合,不會接續上一場</b>。</div><p><b>過程中會看到／聽到</b>(都屬正常,不用處理):</p><ul><li>馬達<b>正反轉交替</b>、轉速時快時慢,聲音跟著變化。</li><li>中途<b>短暫停轉</b>——系統在自動準備下一段量測。<b>不要拔電</b>。</li><li>畫面顯示已進行時間與<b>電流落點圖</b>(每一輪一個點)。<b>前段點位會先往上是正常的</b>——新馬達的電刷還沒與整流子貼合,那段讀值本來就不穩、不代表變差;之後點位會往下走並收斂,<b>收斂就是磨順了</b>。</li><li>想中途結束按「<b>停止</b>」,已完成的數據會保留在畫面上。</li></ul><p><b>完成時</b>顯示磨前後對照(磨合前電流穩定度／磨合後電流穩定度)與停止方式,結果訊息如實告知:</p><table class='manual-table'><thead><tr><th>完成訊息</th><th>意思</th></tr></thead><tbody><tr><td>&#10003; 磨合完成——這顆馬達已磨順,可以上場</td><td>正常完成,這顆收工</td></tr><tr><td>&#9888; 此馬達磨無改善且訊號劣化——判定為嚴重耗損,不建議繼續磨合</td><td>系統判定這顆已嚴重耗損、磨不出改善——如實告知,別再花時間</td></tr></tbody></table><div class='manual-note'><b>注意</b>:曲線與數據<b>只顯示本場</b>(不留歷史紀錄);按「歸零」或啟動新場即清除。想留存結果,完成畫面的磨前後對照(磨合前／後電流穩定度、停止方式)就是這場的成績單。對<b>已磨到位的馬達</b>再啟動:系統會快速確認狀態後自動停止(顯示磨合完成)——不會傷馬達,但也沒必要常做。</div>"
            )},
            {"id": "standardflow", "t": "七、標準磨合流程(磨前量測 → 磨合 → 磨後量測)", "html": (
                "<p class='manual-intro'>想知道「磨合到底有沒有效、效果多大」,照下面的流程走。<b>判讀主軸只有一個:同樣的條件下,馬達轉得更快、或達到同樣轉速需要的電壓更低。</b>兩者是同一件事——電刷與整流子的接觸變好了。以下依你手上的版本與磨合方式分兩條路。</p><h3>路線 A —— 用「AI 智慧磨合」(Pro)</h3><p><b>① 磨前</b>:不必特別量,機器會自己記。<br><b>② 磨合</b>:啟動 →「AI 智慧磨合」磨到自動停(顯示「磨合完成」)。<br><b>③ 判讀</b>:磨合頁直接顯示 <b>磨合前轉速 / 磨合後轉速 / 轉速提升</b>,以及<b>磨合指標曲線</b>。</p><table class='manual-table'><thead><tr><th>看什麼</th><th>有效的樣子</th></tr></thead><tbody><tr><td><b>轉速提升</b></td><td><b>上升</b>——主判讀</td></tr><tr><td>磨合指標曲線</td><td>降到低點不再降=已磨透(機器自動判完成)</td></tr></tbody></table><h3>路線 B —— M1 版,或自己設參數磨合(兩者皆適用)</h3><p>用「<b>馬達特性量測</b>」做磨前磨後對照。它<b>全版本可用</b>、有自動準備(條件一致),而且<b>會存進歷史紀錄</b>,不必手抄。</p><p><b>① 磨前量測</b>:跑一次「馬達特性量測」。<br><b>② 磨合</b>:用「馬達磨合」跑你的配方(電壓模式或轉速模式皆可)。<br><b>③ 磨後量測</b>:再跑一次「馬達特性量測」,打開歷史紀錄兩筆對照。</p><table class='manual-table'><thead><tr><th>看什麼</th><th>有效的樣子</th><th>為什麼</th></tr></thead><tbody><tr><td><b>「各轉速點」表的電壓</b></td><td><b>同一個轉速,需要的電壓下降</b></td><td><b>主判讀</b>——電刷接觸變好的最直接證據</td></tr><tr><td>起轉電壓</td><td>下降</td><td>輔助——電刷開始導通所需的電壓變低</td></tr><tr><td>品質因數</td><td>上升</td><td>輔助——綜合了扭力常數與內阻</td></tr><tr><td>★I0(無載電流)、損耗轉矩</td><td><b>升降都可能,不能單獨判讀</b></td><td>兩股力量方向相反(見下方說明)</td></tr></tbody></table><div class='manual-note'><b>⚠ 磨合後別拿「AI 扭力預測」來判斷磨合效果</b>(Pro 用戶注意):磨合會讓空載轉速上升,而「預測最大扭力」正是由空載轉速推算的——所以<b>磨合後這個數字通常會下降,這是正常的,不代表馬達變弱</b>。扭力主要由磁鐵決定,磨合改變不了磁鐵。判讀磨合效果請用上面兩條路線;扭力預測是用來比較「不同馬達」或「同一顆的長期狀態」。</div><div class='manual-note'><b>為什麼「內耗／無載電流」升降都可能?</b>電刷磨合的物理就是「把電刷磨出更大的接觸面」——<b>接觸面越大,能通過的電流越多</b>。所以一顆乾淨的新馬達磨合後,空轉電流常常是<b>升</b>的;而一顆髒污或久置的馬達,磨掉髒污讓電流<b>降</b>的效果可能更大。<b>兩種都正常</b>,所以它自己說明不了磨合有沒有效。</div><p><b>④(建議,Pro 限定)建立健康指紋</b>:磨合完成＝這顆的巔峰狀態——此時到「AI 智慧馬達健康管理」建立<b>健康指紋</b>,之後定期檢測就能看出它的變化(詳見「十二、AI 健康管理」)。</p><div class='manual-note'><b>量測條件(自動處理)</b>:磨前／磨後量測的條件由系統自動一致化,不需手動等待或設定;結果頁顯示「量測溫度」可供核對。磨合剛結束建議稍等數分鐘再做磨後量測,其餘交給系統處理。</div>"
            )},
            {"id": "torque", "t": "八、AI 扭力預測系統(Pro)", "html": (
                "<p class='manual-intro'>用<b>田宮官方規格當基準</b>,推算這顆馬達的扭力,和官方標準<b>畫在同一張圖上</b>。<br><b>量測誤差:&#177;10%</b><br>回答「這顆跟官方標準差多少」——<b>一眼看兩條線的高低,不必解讀分數</b>。</p><p><b>操作</b>:首頁 →「AI 扭力預測系統」→ 選<b>馬達型號</b>(田宮全 15 款;型號要選對,基準才對)＋填<b>備註</b>(選填,40 字以內)→「開始預測」→ 全程自動,畫面只顯示「<b>數據收集中</b>」與進度(過程中請勿觸碰馬達)→ 約 <b>90 秒</b>跑完顯示結果頁。</p><p><b>結果頁怎麼看</b>:</p><table class='manual-table'><thead><tr><th>項目</th><th>意思</th><th>怎麼判讀</th></tr></thead><tbody><tr><td><b>扭力預測圖</b></td><td>兩條線:亮色＝<b>田宮官方標準品</b>,另一條＝<b>這顆馬達</b>。橫軸轉速、縱軸扭力,每條線由該馬達在<b>兩個測試電壓下的工作點</b>連成</td><td><b>線在標準線下方＝力氣比標準小</b>——看兩條線的高低就好</td></tr><tr><td><b>預測扭力</b>(圖的下方)</td><td>兩個測試電壓各一個預測最大扭力</td><td>例:「2.4V 7.59 mN·m／3.0V 9.71 mN·m」。<b>數字越大力氣越大</b></td></tr><tr><td><b>平均轉速</b></td><td>兩個測試電壓各一個量測期間的平均轉速(rpm)</td><td>供參考;同顆前後對照較有意義</td></tr><tr><td><b>量測溫度區間</b></td><td>這次量測期間的溫度落在哪</td><td>跨日或跨季比較同一顆時一併看——溫差越大,數字可比性越低</td></tr></tbody></table><p><b>幾個一定要知道的</b>:</p><ul><li><b>這是「參考值」,不是扭力計實測</b>——用途是<b>比較</b>(不同馬達之間、同一顆的長期變化),看兩條線的相對高低就好,<b>別把絕對數字當成儀器級精度</b>。</li><li><b>扭力是天生的,磨合改不了</b>——所以<b>別拿這個數字判斷磨合有沒有效</b>(磨合後它通常會下降,那是正常的,原因見「七、標準磨合流程」的警語)。磨合效果請照該章的<b>兩條路線</b>判讀。</li><li><b>以田宮官方標準為基準</b>(不是實體扭力計絕對值);官方規格是玩家共同的認知座標,這樣才好互相溝通。</li><li><b>同型號不同顆數值不同＝正常</b>:反映每顆的真實個體差異,不是量錯。</li><li><b>型號務必選對</b>:選錯型號＝拿錯基準比,數字就沒意義。</li></ul><div class='manual-note'><b>注意</b>:全程自動、勿觸碰馬達;量測未完成時先查馬達架設與轉速感測對位再重測;高溫會自動中止。</div>"
            )},
            {"id": "test", "t": "九、馬達測試", "html": (
                "<p class='manual-intro'>單階段即時觀察,<b>不寫入紀錄</b>。<br><b>量測誤差:&#177;1%(轉速)</b></p><p>首頁 →「馬達測試程式」→ 設 <b>電壓(0.6~4.0V,預設 1V)/ 運轉時間(10~600 秒,預設 60)/ 方向 / 穩定電流容差(2~50mA)/ 判停標準</b>(純時間限制 或 智慧穩定＝電流提前穩定即提早結束,預設後者;此設定與磨合頁<b>各自獨立</b>)→「啟動」→ 看即時數據與圖表(含 <b>KV</b> 即時值),到時或穩定即自動停。</p><div class='manual-note'><b>注意</b>:電壓上限 4.0V 保護馬達,勿繞過;反轉接正轉前先按一次「停止」。本程式<b>不做任何自動準備</b>——按下啟動立即開始、時間到準時停止(需要條件一致的量測請用特性量測／扭力預測)。</div>"
            )},
            {"id": "records", "t": "十、歷史紀錄", "html": (
                "<p class='manual-intro'>自動儲存每次磨合完整資料,最多 <b>50 筆</b>。</p><p>每筆顯示名稱 / 開始時間 / 時長 / 模式 / 結束原因 / 最大轉速 / 平均轉速 / 穩定電流。</p><table class='manual-table'><thead><tr><th>按鈕</th><th>用途</th></tr></thead><tbody><tr><td>檢視</td><td>看每一階段數據(多趟紀錄逐趟列出各階段;含暫停設定與實際等待秒數)</td></tr><tr><td>套用</td><td>把配方(<b>電壓／轉速模式</b>、趟數、各趟 10 階段參數,電壓表與轉速表都還原、含暫停設定)一鍵套回磨合頁,磨合頁自動切到該紀錄的模式;舊單趟紀錄套用後趟數=1</td></tr><tr><td>匯出</td><td>下載 JSON(可再匯入)或 CSV(Excel 開)</td></tr><tr><td>刪除</td><td>移除(不可復原)</td></tr></tbody></table><ul><li><b>平均RPM 前的「≈」</b>:該階段轉速未達判穩標準,記錄的是運轉末段的滾動平均(與運轉時畫面顯示的平均轉速相同)。</li><li><b>容量滿(50 筆)</b>:管理中可選「自動覆寫」(啟動時刪最舊)或「不覆寫」(預設,啟動被擋需手動清)。</li><li><b>匯入</b>:選之前匯出的 JSON(id 重複會覆蓋)。只收 JSON。每個匯出檔帶<b>簽章驗證</b>:同台 / 同批機器可互通,竄改或非本批機器的檔會被拒絕;改檔名不影響(驗的是內容)。</li><li><b>檔名</b>:<code>motorlab_&lt;日期&gt;_&lt;時間&gt;_&lt;型號&gt;[_&lt;備註&gt;]</code>,採磨合開始時間 → 同筆重複匯出檔名一致。</li><li>韌體更新 / WiFi 重設<b>都不會清紀錄</b>。</li></ul>"
            )},
            ...
            {"id": "health", "t": "十二、AI 智慧馬達健康管理(Pro)", "html": (
                "<p class='manual-intro'>為每顆馬達建立<b>健康指紋</b>——磨合完成時的巔峰狀態快照——之後定期重測,看<b>從指紋以來的變化</b>。<b>跟自己比,不跟別顆比</b>。<br><b>量測誤差:&#177;5%</b></p><p><b>正確使用順序(重要)</b>:先把馬達<b>磨合完成</b>(建議用 AI 智慧磨合磨到自動停),再建立指紋。指紋代表這顆馬達的最佳狀態,之後每次檢測都跟它與上一次比。</p><ol><li>首頁 →「AI 智慧馬達健康管理」→「+ 新增馬達」。</li><li>填 <b>馬達型號</b>(下拉,必選——診斷需要對照該型號的標準)+ <b>備註</b>(選填)。</li><li>確認 → 自動跑約 <b>7~8 分鐘</b> 建立指紋(特性量測 3 趟 → 電刷接觸;含各段自動準備)。若機器提示「<b>可能尚未磨透</b>」:代表這顆的內部損耗還偏高,建議先跑 AI 智慧磨合,完成後重建指紋。</li></ol><p>之後每張卡片可做:</p><ul><li><b>完整檢測</b>:<b>磁力／內部損耗／電刷接觸</b>三個面向對指紋比對,最完整。</li><li><b>快速檢測</b>:只比對內部損耗,適合日常快篩。</li></ul><p>結果頁列出<b>從指紋以來的變化</b>。每一項給四樣東西:目前值、對指紋的變化百分比、一條<b>量測誤差範圍</b>、以及落點在帶內還是帶外。<b>帶內＝量測本身的重複性,不是馬達變了;帶外才超出量測誤差能解釋的範圍。</b>連續兩次都落在帶外,才建議當作真的變化看待。<b>系統只呈現數值與變化,不評分,也不判斷該不該更換</b>——請對照你自己的使用感受決定。結果附這次的量測溫度。</p><div class='manual-note'>機器告訴你變化了多少,怎麼判讀由你決定。磁力數值已做溫度校正,跨季比較較為可靠;內部損耗與電刷穩定度未校正,請盡量在相近溫度下比較。<b>±2% 以內的變化多半是量測散布,不是馬達真的變了。</b></div><p>馬達卡片上顯示最近一次檢測時間(只建過指紋、還沒檢測過的顯示「已建指紋 + 時間」)。詳情頁可看歷次檢測,以及<b>量測變化趨勢圖</b>——<b>起點是你建立指紋的那一次</b>,各項都以它為 100%,不會隨檢測次數往前漂。圖下附「怎麼讀這張圖」說明。</p><p><b>怎麼看方向</b>:電流與轉速<b>一起</b>上升,是接觸面隨磨耗增加的樣子——只有一個動不算。所以轉速不能單看:磨合變順時它會上升,磨耗時它也會上升,要和電流一起讀。磁力下降、內耗上升是往損耗變大的方向;數值開始亂跳、散布變大代表接觸不穩。</p><p><b>什麼時候要重建指紋</b>:洗馬達／深度保養之後、或檢測顯示「比指紋更順了」時——把新狀態設為新基準。舊指紋會保留在歷史裡,成為這顆馬達的生命履歷。</p><div class='manual-note'><b>注意</b>:每顆最多 50 次歷史,整機最多 20 顆;檢測中勿斷電／勿按其他鈕;高溫會自動中止;舊版建立的指紋需重建一次;M1 版按鈕灰色(點下提示升級)。</div>"
            )},
            {"id": "bearing", "t": "十三、軸承阻力測試", "html": (
                "<p class='manual-intro'>量軸承順暢度,任何版本可用。<b>完全靜止時間越久 → 軸承越順</b>。<br><b>量測誤差:&#177;10%</b></p><p>首頁 →「軸承阻力測試」→ 選測試電壓(<b>2.4V 或 3V</b>)→「開始測試」→ 機器加速到該電壓 → 穩定轉速 5 秒 → <b>直接斷電(不剎車)</b> → 計時到完全靜止 → 顯示 <b>完全靜止時間</b>(小數第 2 位)與<b>量測溫度</b>。</p><div class='manual-note'><b>注意</b>:馬達空載慣性小,本測試<b>只顯示時間</b>,請拿同一顆馬達不同時期、或不同馬達的時間互相比較;需轉速感應器正常;建議測 2~3 次看重複性。溫度低時油較稠、時間會偏短——系統必要時會<b>自動準備後再測</b>;溫度過低或過高時會提示「數據僅供參考」。</div>"
            )},
            {"id": "brush", "t": "十四、電刷接觸穩定測試", "html": (
                "<p class='manual-intro'>看電刷與整流子的接觸穩不穩,<b>任何版本可用</b>。把量到的電流波形畫成一張圖,<b>波形越穩＝接觸越穩</b>。<br><b>相對比較工具,不設絕對誤差。</b></p><p><b>操作</b>:首頁 →「電刷接觸穩定測試」→「開始測試」→ <b>全程自動</b>(含自動準備),過程中畫面只顯示「<b>數據收集中</b>」與進度 → 跑完顯示落點圖。</p><p><b>結果頁怎麼看</b>:</p><table class='manual-table'><thead><tr><th>元素</th><th>意思</th></tr></thead><tbody><tr><td><b>落點曲線</b></td><td>採樣期間的電流走勢。<b>越平順＝電刷接觸越穩</b>;起伏大＝接觸有跳動</td></tr><tr><td><b>平滑</b></td><td>拖曳滑桿調整曲線的平滑程度(1~10 級),只影響看圖的細緻度,不改數據</td></tr><tr><td><b>原始雲</b></td><td>打開後可看到原始資料的分布範圍,關掉只留曲線</td></tr></tbody></table><p><b>怎麼用</b>:</p><ul><li><b>同一顆馬達不同時期</b>比——保養前後、磨合前後,曲線變平就是接觸變好。</li><li><b>同型號不同顆</b>比——挑接觸穩的那顆上場。</li><li><b>不要看絕對數值</b>,這是相對比較工具;不同機器、不同治具夾持狀態都會影響。</li></ul><div class='manual-note'><b>注意</b>:按「確定」關閉結果後,這次的圖形資料會從記憶體清除(容量歸還),需要保留請先截圖。</div>"
            )},
            ...
            {"id": "faq", "t": "十九、常見問題", "html": (
                "<p class='manual-intro'><b>Q:更新韌體後,馬達轉向跟以前相反了?</b><br>A:這是<b>方向認定的修正</b>。舊版把馬達的反轉標成「正轉」,v3.10.1 起改對了——現在畫面上的正轉就是馬達的正轉。若你的治具、貼紙或個人筆記上標了方向,請一併更正。健康指紋若是舊版建立的,磁力判定不受影響;若想要轉速與電流的最高精度,可重建指紋(約 4 分鐘),但非必要。</p><p class='manual-intro'><b>Q:健康檢測說磁力衰退,但我這顆是新的?</b><br>A:先清潔整流子與電刷再測一次。接觸面沾油或髒污會讓磁力讀值大幅偏低,系統雖然能分辨大多數這類情況並改提示「先清潔後重測」,但污染程度輕微時仍可能讀不準。<b>請勿往馬達內噴油</b>——油一旦爬到整流子,所有電氣量測都會失真。</p><p class='manual-intro'><b>Q:為什麼 AI 智慧磨合比以前跑得久?</b><br>A:v3.10.1 起改為「單場磨到這顆的最佳狀態才停」;v3.12.2 的完成判定更嚴謹,比舊版更晚收手——舊版常在馬達還在進步時就停了。多數馬達單場約 1.5~2 小時,時間上限建議留 3h。相對地,磨完就是磨到位;若這顆本來就已經磨好,系統會直接告知不需再磨,不會空跑。</p><p class='manual-intro'><b>Q:AI 智慧磨合的啟動鈕是灰的,按不下去?</b><br>A:三種情況,畫面上都會寫原因:①選到銅刷類型號(暫不支援智慧磨合,請改用馬達磨合程式);②馬達型號與底盤的軸型不符(例如 PRO 雙軸馬達配單軸底盤)——到系統設定「馬達與底盤」重選底盤;③機器正在運轉或高溫鎖定中。磨合程式與馬達測試在型號與底盤不符時同樣無法啟動。</p><p class='manual-intro'><b>Q:扭力曲線圖裡我的線在標準線下面,是壞掉了嗎?</b><br>A:不一定。田宮官方規格是該型號的標稱值,同型號個體差異本來就大,而且馬達用久了磁力會逐漸衰退。線略低於標準線很常見;明顯偏低才值得檢查磁鐵或考慮更換。要判斷「磨合有沒有效」請看「七、標準磨合流程」的判讀方式,不是看這張圖——扭力是天生的,磨合改不了。</p><table class='manual-table'><thead><tr><th>問題</th><th>處理</th></tr></thead><tbody><tr><td>開機沒嗶聲</td><td>確認電源 5V</td></tr><tr><td>連得上但網頁打不開</td><td>確認是 <code>http://</code>(非 https)、關行動數據、強制重整(Ctrl+Shift+R)</td></tr><tr><td>一直顯示「套用中…」</td><td>通常 WiFi 不穩,重整網頁即可(內建 8 秒監視會轉紅字提示)</td></tr><tr><td>長時間磨合中手機 / 平板斷線</td><td>裝置閒置會自動斷開熱點,屬正常現象——重新連上機器 WiFi 並重整頁面即可;磨合在機器端持續進行,不受斷線影響</td></tr><tr><td>忘記 WiFi 密碼連不上</td><td>用機上 WiFi 重設接點長按 5 秒(見「十八、WiFi 重設」),只重設熱點名稱與密碼,其他設定與紀錄全保留</td></tr><tr><td>響了 4 長聲自動停機,怎麼恢復</td><td>依畫面顯示的原因排除(馬達未夾緊 / 端子接觸不良 / 輸出短路 / 感測器沒對準)→ 不用重開機,直接重新「啟動」即可,故障狀態會自動清除</td></tr><tr><td>一啟動幾秒就自動停</td><td>通常是保護動作,看畫面原因:電流過低=馬達沒接好;電流過高=卡轉或短路;另檢查是否有供電不足紅色警示</td></tr><tr><td>馬達在轉但轉速顯示 0</td><td>檢查反射標記是否面向感測器、治具是否對準;避免強光直射感測區。持續讀不到會觸發保護自動停機(約 4 秒)</td></tr><tr><td>高溫鎖定解不開</td><td>等到溫度降到門檻以下再按「歸零」;若環境溫度偏高,可到系統設定調高門檻(上限 60°C)或檢查溫度校正補償</td></tr><tr><td>轉速模式階段標「未達標」</td><td>目標轉速超過該馬達能力(以安全上限電壓跑滿時間收尾)→ 調低目標轉速;若馬達明明有力,檢查治具架設與感測器</td></tr><tr><td>AI 智慧磨合為什麼有時跑很久</td><td>它磨到判定「已磨至最佳狀態」才停,每顆馬達狀況差異大——全新品要完整整型、狀況好的馬達很快確認完成;可用時間上限(2h／3h／4h)兜底</td></tr><tr><td>AI 智慧磨合一場磨完就好了嗎</td><td>是——<b>單場到位</b>:系統在一場內磨到這顆的最佳狀態才停,顯示「磨合完成」即可上場;完成畫面的磨前後對照(磨合前／後電流穩定度、停止方式)就是這場的成績單(詳見「六、AI 智慧磨合」)</td></tr><tr><td>拿到一顆不知道磨過沒的馬達,該先磨嗎</td><td><b>建議直接磨</b>。機器沒辦法可靠地分辨「全新未磨」與「已磨透」——兩者的內部損耗常常落在同一帶。<b>AI 智慧磨合本身就會判斷</b>:已經磨透的馬達跑起來很快就會收斂停止,不會浪費時間;沒磨透的才會真的磨。</td></tr><tr><td>特性量測 / 健康建檔要跑好幾分鐘,正常嗎</td><td>正常。全程含<b>自動準備</b>(趟與趟之間也會準備),為的是讓 3 趟在同樣條件下量——省掉準備,量出來的差異會是條件差異而不是馬達差異,那筆數據就沒有比較價值了。特性量測約 6~7 分鐘、健康建檔約 7~8 分鐘</td></tr><tr><td>3 趟一致性數值偏大怎麼辦</td><td>這個欄位<b>只給數值</b>,由你自己判讀。先檢查馬達是否夾緊、治具與感測器有無鬆動,排除後重測。<b>全新未磨合的馬達數值天生偏大</b>(它在量測當下還在變化),屬正常,磨合完成後再量會明顯收斂</td></tr><tr><td>支援哪些馬達</td><td>田宮 Mini 4WD 130 型馬達(單軸 / 雙軸皆可上治具)</td></tr><tr><td>供電器有什麼要求</td><td>DC 5V / 6A 以上、具安規認證;供電不足時介面會出現警示,常見於線材過細或小瓦數供電器。⚠ <b>規格不符的電源會損壞機器並有火災風險,且不予保固</b>(見「十七、安全與保護」)</td></tr><tr><td>取得授權卡在連線</td><td>家裡 WiFi 密碼錯 / 無外網 / 訊號弱 → 重輸入或換 WiFi</td></tr><tr><td>Pro 退費後</td><td>機器連網重驗時<b>自動退回 M1</b>;想再買按「重新取得授權」</td></tr><tr><td>紅色「AP 密碼仍為預設」橫幅</td><td>至 WiFi 設定改密碼</td></tr><tr><td>量測資料會上傳雲端嗎</td><td>不會,100% 存在機器本機;只有你主動按「上傳」的配方會進全球資料庫</td></tr><tr><td>歷史紀錄滿 50 筆會怎樣</td><td>預設自動覆蓋最舊一筆(可關閉);重要紀錄建議先匯出 JSON/CSV</td></tr><tr><td>軟體更新會清掉我的紀錄嗎</td><td>不會,更新保留所有設定、校正與歷史紀錄</td></tr><tr><td>更新失敗會變磚嗎</td><td>不會,有自動回退到前一版本</td></tr><tr><td>待機可拔電源嗎</td><td>可,建議馬達完全停止、無「套用中」、無更新進行中</td></tr></tbody></table>"
            )},
            {"id": "physics", "t": "二十、物理知識", "html": (
                "<p class='manual-intro'>量測與磨合中會遇到的物理名詞,白話拆解——看懂數字的意義。</p><table class='manual-table'><thead><tr><th>名詞</th><th>白話說明</th></tr></thead><tbody><tr><td><b>穩態(收斂)</b></td><td>磨合指標「<b>不再進步</b>」的狀態＝磨好了。磨合要磨幾趟沒有標準答案,看的是指標有沒有收斂;<b>AI 智慧磨合</b>就是持續偵測、確認已磨至最佳狀態才自動停止。電壓／轉速模式只判斷「單一階段」是否穩定,整體程度由你依各趟結果判讀。技巧:新馬達把穩定容差<b>由大到小逐趟收斂</b>——前段寬容差讓粗糙期順利換階,最後一趟小容差把關「真的穩了」</td></tr><tr><td><b>磨合黃金點</b></td><td>一顆馬達「進步剛好吃完、損耗尚未開始」的最佳停手點。磨合的進步不是無限的:前段每場都有感進步,到某一場之後進步歸零——再磨下去只剩電刷損耗與退磁(見「退磁」條),把賺到的性能一點一點還回去。黃金點每顆都不同,無法用固定場數或時間背出來——<b>AI 智慧磨合</b>(見「六」)會在單場內自動磨到並停在這個點</td></tr><tr><td><b>判停標準</b></td><td>每個磨合階段「怎樣算穩、何時往下走」的判斷依據(磨合頁可選)。其中「<b>智慧穩定</b>」自動判定穩定程度,不必自己估時間</td></tr><tr><td><b>換階</b></td><td>磨合從一個階段進入下一個階段。判停標準達標就自動換階——換階快慢本身就是磨合進展的訊號</td></tr><tr><td><b>穩定電壓</b></td><td>階段判定穩定當下馬達的實得電壓。同條件下跨趟比較它的變化,就是磨合進展的量化證據</td></tr><tr><td><b>穩定容差</b></td><td>判定「夠穩」所允許的波動範圍——容差越小、把關越嚴(設定技巧見「穩態」條)</td></tr><tr><td><b>起轉電壓</b></td><td>讓馬達從靜止開始轉動所需的最低電壓。越低代表內部越順</td></tr><tr><td><b>換向火花</b></td><td>電刷在整流子上切換電流的瞬間產生的微小電弧。它同時是雜訊、損耗與磁鐵退化的來源——接觸面磨得越順,火花越小</td></tr><tr><td><b>退磁</b></td><td>磁鐵磁力變弱。磁力不是被「用掉」的(放著一百年也不會少),是被「<b>敲掉</b>」的:每一次換向火花＝一次反向磁場的微小打擊,長時間高轉速(尤其含正反轉)累積上億次,磁力就一點一點<b>不可逆</b>地變弱——這時轉速看起來反而變快,其實是磁力變弱的假象,不是變強。<b>磨到黃金點就停</b>(AI 智慧磨合會自動停在這個點),多磨的每一分鐘都是壽命的消耗</td></tr><tr><td><b>假導通(導電磨合油假象)</b></td><td>碳粉暫時導電造成數值特別漂亮的<b>假象</b>,非真實磨合。本機判定的根基是馬達真實電氣狀態,導電油會使讀數失真偏樂觀——請洗淨油品後再量測(詳見「五、馬達磨合」警告)</td></tr><tr><td><b>KV 值</b></td><td>目前轉速 ÷ 馬達實得電壓(rpm/V),快速比對馬達狀態的指標——同電壓下數字越高轉得越快</td></tr><tr><td><b>馬達內耗(空載損耗)</b></td><td>馬達空轉時自己吃掉的電(電刷摩擦＋軸承阻力)——想像引擎的<b>怠速油耗</b>:還沒推車就先消耗。<b>數字越低越好</b>:內耗低＝更多電力真正用在推車上。<b>百分比的基準</b>＝該型號依官方規格換算的「標準內耗」為 100%(例 30% 即這顆的空轉自耗約為標準基準的三成,跨型號同一把尺)。<b>看三態,不看單點</b>:①<b>持續下降</b>＝磨合還在進步(新品 30% → 磨好 26%);②<b>降到不再降</b>＝到了這顆的底＝磨好;③<b>觸底後回升</b>＝電刷／換向面老化或過磨警訊。不是越低越好到無限;異常偏低反而先懷疑量測或假導通(見「假導通」條),複測確認</td></tr><tr><td><b>扭力預測圖</b></td><td>AI 扭力預測的輸出:把這顆的推算扭力和田宮官方標準<b>畫在同一張圖</b>,看兩條線的高低差。它反映繞線與磁鐵的先天條件——<b>磨合改變不了力氣</b></td></tr><tr><td><b>I0(無載電流)</b></td><td>馬達空轉時吃掉的電流。同轉速下越低越順</td></tr><tr><td><b>T_loss(損耗轉矩)</b></td><td>馬達內部自己吃掉的轉矩(電刷摩擦＋軸承阻力＋風阻)。越低越好</td></tr><tr><td><b>Tc(庫倫摩擦)</b></td><td>損耗中<b>與轉速無關</b>的那一份,主要是電刷壓在整流子上的乾摩擦</td></tr><tr><td><b>Km(品質因數)</b></td><td>磁力 ÷ √繞組電阻。同樣的電能換到多少扭力——與繞線圈數無關,跨型號也可比</td></tr><tr><td><b>損耗擬合 R²</b></td><td>損耗曲線的貼合程度,越接近 1 這筆數據越可信</td></tr><tr><td><b>3 趟一致性</b></td><td>三趟量測的 I0 最大差異。純數值呈現</td></tr><tr><td><b>參考轉速</b></td><td>智慧磨合每輪在<b>固定相同條件</b>下量的基準轉速。條件固定,跨輪的變化才全是馬達本身的變化——這就是它存在的意義</td></tr><tr><td><b>自然漂移</b></td><td>同一顆馬達每次量的數值有點不同——正常。電刷接觸與溫度會造成小幅漂移;判讀看<b>趨勢與多次平均</b>,不要比單點</td></tr><tr><td><b>系統性差異(量測基準)</b></td><td>你的數據跟別人／網路上的比不起來的原因:電壓基準、供電、治具、量測方式不同,都會造成整體性的偏移;<b>同一台機器上的前後比較</b>最可靠</td></tr><tr><td><b>軸承阻力</b></td><td>軸與軸承之間的機械摩擦阻力——內耗的機械成分之一。專屬測試見「十三、軸承阻力測試」</td></tr><tr><td><b>電刷接觸穩定</b></td><td>電刷與整流子接觸的穩定程度——接觸忽好忽壞,數值就跳動。專屬測試見「十四、電刷接觸穩定測試」</td></tr><tr><td><b>漣波</b></td><td>電流上細小的快速波動——換向與接觸品質的「指紋」,越平穩代表電刷貼合越好</td></tr></tbody></table>"
            )},
        ...
        "en": [
            ...
            {"id": "health", "t": "12. AI Motor Health Manager (Pro)", "html": (
                "<p class='manual-intro'>Build a <b>health fingerprint</b> for each motor — a snapshot of its peak state at break-in completion — then re-measure periodically and read <b>the change since the fingerprint</b>. <b>Compare against itself, not other units.</b><br><b>Measurement error: &#177;5%</b></p><p><b>Correct order (important)</b>: first <b>finish breaking in</b> the motor (ideally with AI Smart Break-in to auto-stop), then build the fingerprint. The fingerprint is this motor at its best; every later check compares against it and against the previous check.</p><ol><li>Home &rarr; &quot;AI Motor Health Manager&quot; &rarr; &quot;+ Add motor&quot;.</li><li>Fill in the <b>motor model</b> (dropdown, required — diagnosis needs that model&#39;s standard) + <b>note</b> (optional).</li><li>Confirm &rarr; runs about <b>7&ndash;8 minutes</b> to build the fingerprint (3-pass characterization &rarr; brush contact, including automatic preparation for each stage). If it warns <b>&quot;may not be fully broken in&quot;</b>, the internal loss is still high — run AI Smart Break-in first, then rebuild the fingerprint.</li></ol><p>Each card can then run:</p><ul><li><b>Full check</b>: compares <b>magnetism / internal loss / brush contact</b> against the fingerprint — the most complete.</li><li><b>Quick check</b>: compares internal loss only, for day-to-day screening.</li></ul><p>The result page lists <b>the change since the fingerprint</b>. Each item gives four things: the current value, the percentage change against the fingerprint, a <b>measurement-error band</b>, and whether it lands inside or outside that band. <b>Inside the band = the repeatability of the measurement itself, not the motor changing; only outside the band exceeds what measurement error can explain.</b> Only when two checks in a row land outside is it worth treating as a real change. <b>The system only presents values and changes; it does not score, and it does not judge whether to replace anything</b> &#8212; decide against your own experience of how the motor feels. The result carries the measurement temperature for that run.</p><div class='manual-note'>The machine tells you how much changed; the interpretation is yours. Magnetism is temperature-corrected, so cross-season comparison is fairly reliable; internal loss and brush stability are not corrected, so compare them at similar temperatures. <b>A change within &plusmn;2% is usually measurement spread, not the motor actually changing.</b></div><p>Each motor card shows the time of the latest check (a motor with only a fingerprint shows &quot;fingerprint built + time&quot;). The detail page lists every past check, plus a <b>change trend chart</b> &#8212; <b>the starting point is the run where you built the fingerprint</b>, with each item set to 100% against it, so it does not drift forward as checks accumulate. A &quot;how to read this chart&quot; note sits below it.</p><p><b>Reading the direction</b>: current and RPM rising <b>together</b> is what a contact face growing with wear looks like &#8212; one moving alone does not count. So RPM cannot be read on its own: it rises as break-in smooths the motor, and it also rises as the motor wears; read it with the current. Falling magnetism and rising internal loss point toward growing losses; numbers starting to jump around, with wider scatter, mean unstable contact.</p><p><b>When to rebuild the fingerprint</b>: after washing or deep maintenance, or when a check shows the motor is smoother than the fingerprint — set the new state as the new baseline. The old fingerprint stays in history as this motor&#39;s life record.</p><div class='manual-note'><b>Note</b>: up to 50 records per motor and 20 motors per machine; during a check do not cut power or press other buttons; overheating aborts automatically; fingerprints built on an older version need one rebuild; on M1 the button is greyed out (tapping prompts to upgrade).</div>"
            )},
            {"id": "bearing", "t": "13. Bearing Resistance Test", "html": (
                "<p class='manual-intro'>Measures bearing smoothness; works on any version. <b>Longer time to full stop → smoother bearing.</b><br><b>Measurement error: &#177;10%</b></p><p>Home → &quot;Bearing Resistance Test&quot; → pick test voltage (<b>2.4V or 3V</b>) → &quot;Start&quot; → the machine accelerates to that voltage → holds a steady speed 5 s → <b>cuts power directly (no braking)</b> → times to full stop → shows the <b>full-stop time</b> (to 2 decimal places) and the <b>measurement temperature</b>.</p><div class='manual-note'><b>Note</b>: the motor's no-load inertia is small, so this test <b>only shows time</b>; compare the same motor over time, or different motors, by their times; needs a working speed sensor; test 2–3 times for repeatability. When cold the oil is thicker and the time runs short — the system <b>prepares automatically before testing</b> when needed; if the temperature is too low or too high it shows &quot;data for reference only.&quot;</div>"
            )},
            {"id": "brush", "t": "14. Brush Contact Stability Test", "html": (
                "<p class='manual-intro'>Shows how steady the brush-commutator contact is; <b>works on any version</b>. It plots the measured current waveform: <b>the steadier the trace, the steadier the contact</b>.<br><b>A relative-comparison tool; no absolute error is specified.</b></p><p><b>How to run</b>: Home &rarr; &quot;Brush Contact Stability Test&quot; &rarr; &quot;Start test&quot; &rarr; <b>fully automatic</b> (including automatic preparation); the screen shows only <b>&quot;collecting data&quot;</b> and progress &rarr; the scatter chart appears when it finishes.</p><p><b>Reading the result page</b>:</p><table class='manual-table'><thead><tr><th>Element</th><th>Meaning</th></tr></thead><tbody><tr><td><b>Scatter curve</b></td><td>How the current moves over the run. <b>Smoother means steadier brush contact</b>; large swings mean the contact is jumping</td></tr><tr><td><b>Smoothing</b></td><td>Drag the slider to change how smooth the curve looks (levels 1&ndash;10). It only affects the view, not the data</td></tr><tr><td><b>Raw cloud</b></td><td>Turn it on to see the spread of the raw samples; turn it off to leave just the curve</td></tr></tbody></table><p><b>How to use it</b>:</p><ul><li>Compare <b>the same motor at different times</b> — before and after maintenance or break-in; a flatter curve means better contact.</li><li>Compare <b>different units of the same model</b> — race the one with steadier contact.</li><li><b>Do not read absolute values</b>; this is a relative comparison tool, and the machine and jig clamping both affect it.</li></ul><div class='manual-note'><b>Note</b>: once you press OK to close the result, the chart data for this run is cleared from memory (the capacity is returned). Take a screenshot first if you need to keep it.</div>"
            )},
        ...
        "ja": [
            {"id": "precautions", "t": "〇、使用前に必ずお読みください・安全上の注意", "html": (
                "<div class='manual-note'><b>初回使用前に本章を必ずお読みください。安全上の注意に従わない使用による人身傷害・財物損失・機器損傷については、使用者が自己責任を負うものとし、保証の対象外です。</b></div><h3>🔴 電源の安全</h3><ul><li>本機には <b>DC 5V／6A 以上</b>、<b>安全規格認証済み</b>の電源アダプターを使用してください。</li><li><b>規格外の電源(過電圧・粗悪品・無認証・出所不明・改造品)は機器を損傷させ、火災の危険があります。これによる故障・損害は保証対象外です。</b></li><li>電源ケーブルやコネクタが破損・発熱・異臭がある場合は使用を中止してください。</li></ul><h3>🔴 運転の安全(モーター高速回転)</h3><ul><li><b>モーター運転中は、手・工具・その他の物で回転軸・ギア・反射板に絶対に触れないでください</b>——高速回転により切創・巻き込み・飛散の危険があります。</li><li>運転前にモーターが<b>治具にしっかり固定</b>されているか確認してください。未固定のモーターは飛び出す恐れがあります。</li><li><b>顔・髪・ゆるい衣服・装飾品</b>を運転中のモーターに近づけないでください。</li><li>モーターと周辺部品は運転後<b>高温になります</b>。停止直後に素手で触れないでください。</li><li>運転中に異音・異臭・発煙・火花があれば、<b>直ちに電源を切り</b>点検してください。</li></ul><h3>🔴 環境の安全</h3><ul><li><b>本機は防水ではありません</b>:水・湿気・雨から遠ざけて使用・保管し、液体(水・油・飲料)を本体や回路にかけないでください。</li><li><b>平らで頑丈・耐熱・不燃</b>の台に置いてください。カーペット・紙・可燃物の上で動作させないでください。</li><li>周囲の<b>通風・放熱</b>を保ち、放熱孔を塞がないでください。密閉した高温環境での長時間運転は避けてください。</li><li>火源・熱源・直射日光から遠ざけてください。</li></ul><h3>🔴 操作の安全</h3><ul><li><b>お子様は大人の監督のもとで使用</b>してください。部品とモーターには小物や鋭利な縁が含まれます。</li><li>機器や回路を分解・改造しないでください。指定外のモーターや負荷を駆動しないでください。</li><li><b>端子はモーター接続専用</b>です。電池・電源・その他の負荷を接続しないでください(短絡損傷防止)。</li><li>長期間使用しない場合は<b>電源を抜いて</b>ください。</li></ul><h3>測定の再現性(同一機・同一モーター・回をまたいで)</h3><table class='manual-table'><thead><tr><th>項目</th><th>再現性</th></tr></thead><tbody><tr><td>磁力系</td><td>&#177;5%</td></tr><tr><td>内耗系</td><td>&#177;3%</td></tr><tr><td>回転数</td><td>&#177;1%</td></tr><tr><td>トルク予測</td><td>&#177;10%</td></tr><tr><td>ベアリング完全停止時間</td><td>&#177;10%(約 &#177;0.2 秒)</td></tr><tr><td>ブラシ着地マップ</td><td>絶対規格は設けません</td></tr></tbody></table><div class='manual-note'><b>変化が上表の範囲を超えていなければ、まず測定ばらつきと考えてください。</b></div><h3>⚠ 測定データの注意</h3><ul><li>本機のデータは<b>同一機器での前後比較・相対比較のみ</b>に使用してください。機器／計器が異なるとデータに系統差があるため、<b>他人や市販データと直接比較しないでください</b>。</li><li>測定時は<b>導電性慣らしオイル</b>を使用しないでください(読み値が歪みます。「五、モーター慣らし」参照)。</li><li><b>測定時の温度変化は測定データにある程度のばらつきを生じさせるため、各測定データは参考値です。</b>モーターの磁力、コイル抵抗、ブラシ接触、ベアリングオイルの粘度は<b>いずれも温度で変わり</b>、しかもそれぞれ方向も幅も異なります。機器は測定条件をできる限り揃えていますが、<b>温度の影響を完全に消すことはできません</b>。そのため各測定結果ページには<b>その回の「測定温度」</b>が表示されます——データを判読するとき、とくに同じモーターを<b>日をまたいで、あるいは季節をまたいで</b>比較するときは温度も併せて見てください;温度差が大きいほど数値の比較可能性は下がります。</li></ul><p class='manual-intro'>本機は高温保護、過電流／短絡／ロック／治具外れ検出、ソフトスタート・ソフトストップなど複数の自動保護を内蔵しています(「十七、安全と保護」参照)が、これらは補助であり、<b>安全な操作と監視の代わりにはなりません</b>。</p>"
            )},
            ...
            {"id": "charexp", "t": "四、モーター特性測定", "html": (
                "<p class='manual-intro'>モーターの特性パラメータと損失を全自動で測定し、<b>参考データを提示</b>——同型モーター同士を比較してご自身で判断を。システムが連続測定し、穏やかな処理で新品未慣らしにも適します。<br><b>測定誤差:&#177;5%</b></p><p><b>操作</b>:ホーム →「モーター特性測定」→ 方向選択(既定は正転)+ <b>型番</b>選択(タミヤ 15 種＋「Other」)+ <b>備考</b>入力(任意、40 字以内)→「測定開始」→ 全自動、途中でモーターに触れない → 完了でデータ表を表示し<b>測定履歴に自動保存</b>。</p><div class='manual-note'><b>自動準備</b>:開始を押すと、システムは必要に応じて自動で準備し(状態に「準備中」と表示)、それから測定に入ります。毎回の測定条件を揃えるためで、手動操作は一切不要。<b>回と回の間にも自動準備</b>を行い、3 回が同じ条件で測られることを保証します——これが「3 回の一貫性」がモーター自身を反映できる前提です。環境条件が適さない場合は「<b>データは参考のみ</b>」と表示し、テストは続行。トルク予測と健康管理の測定にも同様に適用されます(トルク予測の画面はより簡素で、「データ収集中」と進捗バーのみを表示し、段階名は別途表示しません)。<b>自動準備も進捗バーに含まれます</b>——バーは最初から進むので、フリーズではありません。</div><p><b>所要時間</b>:自動準備を含め全体で約 <b>6~7 分</b>。画面には常時「データ収集中」と進捗バーが表示されます;区切りと区切りの間は一瞬回転が止まり「次の段を準備中…」と表示されますが、<b>故障ではありません</b>。途中でモーターに触れないでください。</p><p><b>データの見方(表内に各項の方向を表示)</b>:</p><ul><li><b>&#9733; I0(無負荷電流)</b>:同回転数で<b>低いほど良い</b>——3 指標の中で再現性が最も高い。</li><li><b>&#9733; Km(品質係数)/ &#9733; T_loss(損失トルク)</b>:補助指標(Km は高いほど・T_loss は低いほど良い)。</li><li><b>測定温度</b>:測定時の機器温度、確認用(磁力系の数値はシステムが自動校正済みで、異なる日の結果を直接比較できます)。</li><li><b>始動電圧</b>:参考のみ——単発ではばらつきが大きく、同一モーターの長期健康対照向き(後日明らかに上昇=ベアリング／ブラシ劣化の警告)。</li><li><b>損失フィット R&sup2;</b>:データ品質指標(1 に近いほど信頼できる)。</li><li><b>3 回の一貫性</b>:各回 I0 の最大差。<b>純粋な数値表示</b>——どれだけで大きいと言えるかはモーターの状態次第で、万人共通の線はないからです。ご自身で判読を:数値が明らかに大きい時はまずモーターの固定、治具とセンサーの緩みを確認;<b>未慣らしの新品はもともと大きい</b>のが正常で(測定中もまだ変化しているため)、慣らし完了後に測ると明らかに収束します。同一モーターの前後対照が最も参考になります。</li></ul><p><b>測定履歴</b>:測定ページ →「測定履歴」。成功した測定は自動保存(全指標と各回転点データ含む)、最大 <b>50 件</b>、満杯で最古を自動削除;詳細閲覧・削除可。</p><p><b>使い方の目安</b>:</p><ul><li>慣らし後に<b>同じ個体を再測定</b>して対照:損失系は下がるはず(慣らし有効);Ke／R はほぼ不変。</li><li>磁力系は温度補正済みで、温度をまたぐ比較も<b>比較的信頼できます</b>(完全ではありません);<b>損失系(I0／T_loss)</b>は未補正のため、必ず<b>近い温度</b>で比較してください(低温ではオイルが粘く数値が自然に高くなります)。取付直後や冷間再起動後の初回データは高めに出ることがあり、2 回目以降を基準に。</li></ul><div class='manual-note'><b>注意</b>:測定失敗(始動せず／ロックタイムアウト／過電流)は原因を表示、再試行で可。繰り返し失敗、または待機時に回転数が 0 でない場合は、回転センサーと反射板の位置合わせを確認してください。</div>"
            )},
            {"id": "breakin", "t": "五、モーター慣らし(2 モード)", "html": (
                "<p class='manual-intro'>低速で長時間運転し、ブラシと整流子を最適な接触まで馴染ませます。慣らしページ上部に<b>2 つのモードボタン</b>(運転中は切替不可)。</p><div class='manual-note'><b>&#9888; 慣らし前にベアリングへ注油しないでください。</b>オイルがブラシや整流子に付くと測定データが狂い、摩擦が減ることで慣らし時間も大幅に伸びます。正しい順番は:<b>慣らし完了後</b>にベアリングへ注油。(AI スマート慣らしも同様)</div><table class='manual-table'><thead><tr><th>モード</th><th>向いている人</th><th>ひとこと</th></tr></thead><tbody><tr><td><b>電圧モード</b></td><td>自分の配合を持つ人</td><td>各段階を固定電圧で運転(従来方式)</td></tr><tr><td><b>回転数モード (Beta)</b></td><td>回転数を基準にしたい人</td><td>各段階を設定回転数に自動制御、電圧安定で自動的に次段階へ</td></tr></tbody></table><div class='manual-note'>「ワンタップ全自動・完了で自動停止」を求める人は、ホームの独立機能「<b>AI スマート慣らし</b>」(Pro、「六、AI スマート慣らし」参照)をご利用ください。</div><h3>電圧モード</h3><p>ホーム →「モーター慣らしプログラム」→ <b>型番</b>選択(16 種)+ <b>備考</b>(40 字以内)→ <b>判定基準</b>選択(純時間制限=各段階を設定時間まで運転;スマート安定=電流が早めに安定したら次段階へ、時間は上限)→ <b>慣らし回数</b>選択(1~6、既定 1)→ 各回 10 段階のパラメータを確認(複数回はタブで切替;数値欄を直接タップして編集)→「開始」。</p><ul><li>各段階:電圧(0.6~4.0V、<b>0=スキップ</b>)/ 方向 / 慣らし秒(10~600、既定 60)/ 冷却秒(10~600、既定 60)/ <b>一時停止</b>(ON／OFF、既定 OFF)/ 安定電流公差(2~50mA)。</li><li>複数回は「<b>この回を以降すべてにコピー</b>」で素早く入力;回数横に<b>推定総時間</b>を即時表示。</li><li>範囲外の入力は自動的に上下限へ補正し一度点滅して知らせます。</li></ul><h3>例:新品モーターの「回ごとに公差を絞る」慣らし SOP</h3><p>新品はブラシと整流子がまだ整形されていません。次の流れがおすすめです:<b>公差は広いところから始め、1 回につき 1 段ずつ絞り、各段階に必要な時間はモーター自身に決めさせます</b>。</p><p><b>前提</b>:判定基準は「<b>スマート安定</b>」を選択(この手法は「電流が安定したら早めに次段階へ」で成り立ちます;純時間制限では効きません)。電圧はご自身の配合どおりで構いません——例では 1.0V。</p><table class='manual-table'><thead><tr><th>回</th><th>安定電流公差</th><th>慣らし秒(上限として使うので長めに)</th></tr></thead><tbody><tr><td>1</td><td>50 mA</td><td>60</td></tr><tr><td>2</td><td>30 mA</td><td>90</td></tr><tr><td>3</td><td>20 mA</td><td>120</td></tr><tr><td>4</td><td>10 mA</td><td>180</td></tr><tr><td>5</td><td>5 mA</td><td>240</td></tr></tbody></table><p>入力方法:回 1 の各段階に 50 を入力 → タブで回 2 に切り替えて 30 を入力 → 以下同様(同じ回の中は「この回をコピー」で素早く入力できます)。</p><p><b>見るのは 1 つだけ:早めに次段階へ進んだか、時間を使い切ったか</b></p><table class='manual-table'><thead><tr><th>見えたもの</th><th>意味</th><th>次の一手</th></tr></thead><tbody><tr><td>段階が<b>早めに次へ進む</b>(慣らし秒を使い切らない)</td><td>この公差ではすでに安定</td><td>次の回で 1 段絞る</td></tr><tr><td>段階がほぼ<b>時間を使い切って</b>から進む</td><td>この公差にはまだ届いていない</td><td>次の回も<b>同じ公差でもう一度</b>、焦って絞らない</td></tr><tr><td>最小公差でもほぼ早めに進む</td><td><b>慣らし完了</b></td><td>終了。「七、標準慣らしフロー」の慣らし後測定へ</td></tr><tr><td><b>同じ公差で 2 回連続して時間を使い切る</b></td><td><b>この個体の水準はここまで</b></td><td><b>ここで終了、これ以上絞らない</b></td></tr></tbody></table><div class='manual-note'><b>&#9888; 最後の行が最も重要</b>:到達できる安定度は個体ごとに違います。「これ以上絞れない」は慣らし不足ではなく、その個体の底です——<b>これ以上続けても効果はなく、摩耗が増えるだけ</b>。</div><p>ひとこと:冷却秒は既定(60)以上を維持し、回と回の間にモーターをしっかり冷ましてください——温度変動が大きいと次段階への移行が遅く見えます(画面の温度で確認できます)。この一連を全自動でやりたい Pro ユーザーはホームの「AI スマート慣らし」をどうぞ。</p><h3>回転数モード (Beta)</h3><p>電圧モードと同じ段階表ですが、第 1 列が<b>目標回転数</b>(6000~30000、1000 刻み、<b>0=スキップ</b>)に変わります——機器が電圧を自動調整してモーターをその回転数に固定します。</p><ul><li><b>判定基準</b>(厳格 / 標準 / 緩め):その回転数で駆動電圧が安定すれば当段階を馴染んだと見なし早めに次段階へ;慣らし秒は上限保護。厳格=より安定を要求(深く・長め);緩め=早めに次段階(新品が段階を通過できない場合は緩めに)。</li><li>各段階は<b>ゆっくり上昇</b>して進入し、目標付近でロックと計時を開始——目標回転数が高いほど進入時間が長く、正常な動作です。</li><li>段階結果欄に<b>安定電圧</b>を表示;目標回転数に届かない場合は安全上限電圧で時間いっぱい運転し「<b>未達</b>」と表示(通常は目標が高すぎるか、モーター／治具の異常)。</li><li>方向・時間・回数・コピー等の操作は電圧モードと同じ。</li></ul><h3>共通の動作</h3><p>各段階の流れ:ソフトスタート → 運転中 → ソフトストップ → 冷却中 → 次段階;1 回終わると自動で次の回へ(「x/y 回目 · 段階 c」を表示)。全完了 → 3 ビープ → 履歴に自動保存(電圧／回転数モード、各回各段階の結果を含む)。</p><p><b>運転中に押せるボタン</b>:</p><table class='manual-table'><thead><tr><th>ボタン</th><th>動作</th></tr></thead><tbody><tr><td>一時停止</td><td>ソフトストップ後に<b>一時停止</b>、ボタンが「<b>再開</b>」に変わる;再度押すと<b>中断点から続行</b>——段階で走った秒数は保持(再計算なし)、冷却カウントも継続。一時停止に時間制限なし;<b>一時停止中は他のボタンは全ロック、「再開」のみ有効</b></td></tr><tr><td>停止</td><td>ソフトストップ後に終了、記録に「ユーザー中止」</td></tr><tr><td>ホーム</td><td>ホームへ戻る、慣らしは<b>バックグラウンドで継続</b></td></tr></tbody></table><div class='manual-note'><b>一時停止について</b>:一時停止中はモーターが停止して冷え、再開はその段階に追加の冷却を 1 回挟むのと同じで慣らしに無害;再開後は段階の「安定判定」を採り直します(冷熱状態の混同を防ぐ)。<b>電源を切ると一時停止の進捗は保持されません</b>——途中の断電は中止扱い。(「ゼロ」は待機時のみ押せ、前回運転の表示記録をクリア。)</div><div class='manual-note'><b>段階一時停止(段階表の「一時停止」欄)</b>:ON にした段階は<b>冷却終了後に自動で次の段階へ進みません</b>——機器が長音で 1 回ビープして停止し、画面に「設定どおり第 x 回の段階 c のあとで一時停止しました」と表示され、「<b>運転再開</b>」を押してはじめて次の段階に進みます。回と回の間(または特定の段階のあと)でモーターを確認してから続けたいときに使います。待機時間に制限はありません;待機中は他のボタンがロックされ、「運転再開」と「停止」のみ残ります。最後の段階に ON を設定しても効果はありません(その後に段階がないため)。この設定と「一時停止」ボタンは互いに影響せず併用できます;どちらも電源を切ると保持されません。各段階の一時停止設定と<b>実際の待機秒数</b>はその回の履歴に記録され(「閲覧」の一時停止欄、CSV の pause／hold_sec 欄)、レシピを「適用」すると一時停止設定も一緒に戻ります。</div><div class='manual-note'><b>注意</b>:運転中は全設定がロック(一時停止中も同様);途中で電源を切らない(データ消失);高温時は自動停止して保存;素早い動作確認は各段階の時間を短く。リアルタイムデータに <b>KV(rpm/V)</b>＝現在回転数÷モーター電圧 の 1 枠が加わり、モーター状態の素早い比較に使えます;さらに「<b>本段階運転 x / y 秒</b>」が本段階の慣らし進捗を直接表示——<b>全速運転の秒数のみ累計</b>(ソフトスタート／ソフトストップ／一時停止は不算入)、y 秒で次段階へ。</div><div class='manual-note'><b>重要:測定／慣らし時に「導電潤滑オイル」を使用しないでください。</b>「導電」を謳う慣らしオイル(導電カーボン粉入り)は、注入直後に回転数が急上昇・電圧が急降下します。<b>これは本当に慣らせたのではなく、カーボン粉が一時的に導通している見かけです</b>。本機のすべての判定(安定電流 / 回転数 / 内部抵抗)はブラシと整流子の<b>本当の接触状態</b>を測ります。導電オイルは読み値を楽観側に歪めます(この種のオイルの説明書自身も「洗浄後に安定し、より良く回る」と注記)。オイルを洗い落とすと元に戻ります。正しい方法:一切使わない;既に使った場合は徹底的に洗浄してから測定してください。通常のベアリング微量潤滑は影響を受けず、この警告は「導電性慣らしオイル」のみが対象です。</div>"
            )},
            {"id": "smartbreakin", "t": "六、AI スマート慣らし(beta)(Pro)", "html": (
                "<p class='manual-intro'>ワンタップ全自動慣らし:システムが自分で慣らし、自分で測り、<b>1 回のセッションでこの個体の最良状態まで慣らして自動停止</b>します——複数回に分ける必要も、何回やるか自分で判断する必要もありません。</p><p><b>操作</b>:ホーム →「AI スマート慣らし(beta)」→ <b>型番</b>選択 ＋ <b>備考</b>(任意、40 字以内)＋ <b>時間上限</b>(完了まで／2h／3h／4h)を選び →「開始」。<b>あとは全自動</b>、仕上がると自動停止してビープでお知らせします。</p><div class='manual-note'><b>シャーシ</b>:「システム設定 → モーターとシャーシ」と同一の設定で、両方のプルダウンは相互に同期します(「十六、システム設定」参照)。シャーシごとに電池の極性配線が異なり、車上でのモーターの正転方向も変わります;シャーシを正しく選んで初めて、慣らし中の正転・逆転が実車と一致します。型番とシャーシの軸型が合わない場合(例:PRO 両軸モーターに単軸シャーシ)、開始ボタンがグレーになりシステム設定でシャーシを選び直すよう促します;システムが勝手に変更することはありません。</div><div class='manual-note'><b>現在はカーボンブラシ 7 種のみ対応</b>(Hyper-Dash PRO／Mach-Dash PRO／Hyper-Dash 3／Sprint-Dash／Power-Dash／Ultra-Dash／Plasma-Dash)。<b>銅ブラシ 8 種はスマート慣らし未対応</b>で、選ぶと開始ボタンがグレーになり画面に理由を表示します;この 8 種は「モーター慣らしプログラム」をご利用ください。その他の機能(特性測定・慣らしプログラム・テスト)は全 15 種に対応しています。</div><div class='manual-note'><b>所要時間</b>:多くのモーターで約 <b>1.5~2 時間</b>。時間上限は既定の 3h のまま、または「完了まで」を選ぶことを推奨します。2h を選ぶと仕上がる前に上限へ達することがあり、「時間上限に到達、完了は未確認」と表示されます;<b>このとき再度開始すると、前回の続きではなく最初から 1 セッションをやり直します</b>。</div><p><b>途中で見えるもの・聞こえるもの</b>(いずれも正常で、対処は不要):</p><ul><li>モーターが<b>正転と逆転を交互に</b>行い、回転数が上下して音も変化します。</li><li>途中で<b>短く停止</b>します——次の測定を自動準備しているところです。<b>電源を抜かないでください。</b></li><li>画面には経過時間と<b>電流の散布図</b>(1 ラウンドにつき 1 点)が表示されます。<b>前半で点が上がるのは正常です</b>——新品はブラシと整流子がまだ馴染んでおらず、その区間の読値はもともと不安定で、悪化を意味しません;その後は点が下がって収束し、<b>収束すれば馴染んだということ</b>です。</li><li>途中でやめたいときは「<b>停止</b>」を押してください。それまでのデータは画面に残ります。</li></ul><p><b>完了時</b>には慣らし前後の対照(慣らし前の電流安定度／慣らし後の電流安定度)と停止のしかたを表示し、結果を正直に伝えます:</p><table class='manual-table'><thead><tr><th>完了メッセージ</th><th>意味</th></tr></thead><tbody><tr><td>&#10003; 慣らし完了——このモーターは馴染みました、実戦投入できます</td><td>正常完了、この個体は終了</td></tr><tr><td>&#9888; 改善が見られず信号も劣化——重度の消耗と判定、慣らしの継続は非推奨</td><td>重度に消耗して改善が出せないとシステムが判定——正直に伝えます、これ以上は時間の無駄</td></tr></tbody></table><div class='manual-note'><b>注意</b>:曲線とデータは<b>今回のセッションのみ表示</b>(履歴は残りません);「ゼロ」を押すか新しいセッションを開始すると消去されます。結果を残したい場合、完了画面の慣らし前後の対照(慣らし前／後の電流安定度と停止のしかた)がこのセッションの成績表です。<b>すでに仕上がったモーター</b>で再度開始した場合:システムが状態を素早く確認して自動停止します(慣らし完了と表示)——モーターを傷めることはありませんが、頻繁に行う必要もありません。</div>"
            )},
            {"id": "standardflow", "t": "七、標準慣らしフロー(慣らし前測定 → 慣らし → 慣らし後測定)", "html": (
                "<p class='manual-intro'>「慣らしが本当に効いたか、どれだけ効いたか」を知りたいなら、以下のフローで。<b>判読の軸は一つだけ:同じ条件でモーターがより速く回る、または同じ回転数に必要な電圧が下がる。</b>この二つは同じこと——ブラシと整流子の接触が良くなったということです。お使いの版と慣らし方法により 2 つのルートがあります。</p><h3>ルート A —— 「AI スマート慣らし」(Pro)を使う</h3><p><b>① 慣らし前</b>:特に測る必要なし、機器が自動で記録します。<br><b>② 慣らし</b>:「AI スマート慣らし」を開始し、自動停止まで任せる(「慣らし完了」と表示)。<br><b>③ 判読</b>:慣らしページに <b>慣らし前回転数 / 慣らし後回転数 / 回転数の向上</b> と<b>慣らし指標曲線</b>が直接表示されます。</p><table class='manual-table'><thead><tr><th>見るもの</th><th>効いている様子</th></tr></thead><tbody><tr><td><b>回転数の向上</b></td><td><b>上昇</b>——主判読</td></tr><tr><td>慣らし指標曲線</td><td>下がりきってそれ以上下がらない=慣れ切った(機器が自動で完了を判定)</td></tr></tbody></table><h3>ルート B —— M1 版、または自分でパラメータを設定して慣らす(どちらにも適用)</h3><p>「<b>モーター特性測定</b>」で慣らし前後を対照します。<b>全版で使用可</b>、自動準備あり(条件が一致)、さらに<b>履歴に保存される</b>ので手で書き写す必要がありません。</p><p><b>① 慣らし前測定</b>:「モーター特性測定」を 1 回実行。<br><b>② 慣らし</b>:「モーター慣らし」で自分の配合を実行(電圧モード・回転数モードどちらでも)。<br><b>③ 慣らし後測定</b>:再度「モーター特性測定」を実行し、履歴の 2 件を開いて対照。</p><table class='manual-table'><thead><tr><th>見るもの</th><th>効いている様子</th><th>理由</th></tr></thead><tbody><tr><td><b>「各回転点」表の電圧</b></td><td><b>同じ回転数で必要な電圧が下がる</b></td><td><b>主判読</b>——ブラシの接触が良くなった最も直接的な証拠</td></tr><tr><td>始動電圧</td><td>低下</td><td>補助——ブラシが導通し始めるのに必要な電圧が下がる</td></tr><tr><td>品質係数</td><td>上昇</td><td>補助——トルク定数と内部抵抗を総合した値</td></tr><tr><td>&#9733;I0(無負荷電流)、損失トルク</td><td><b>上下どちらもあり得る、単独では判読不可</b></td><td>2 つの力が逆方向に働くため(下記の説明参照)</td></tr></tbody></table><div class='manual-note'><b>&#9888; 慣らし後に「AI トルク予測」で慣らし効果を判断しないでください</b>(Pro ユーザー注意):慣らしは無負荷回転数を上げますが、「予測最大トルク」はその無負荷回転数から推算されます——したがって<b>慣らし後にこの数字は普通むしろ下がります。これは正常で、モーターが弱くなったわけではありません</b>。トルクは主に磁石で決まり、慣らしは磁石を変えません。慣らし効果は上の 2 ルートで判読を;トルク予測は「別のモーター」や「同一個体の長期状態」の比較に使います。</div><div class='manual-note'><b>なぜ「内耗／無負荷電流」は上下どちらもあり得るのか?</b>ブラシ慣らしの物理は「ブラシを削ってより大きな接触面を作る」こと——<b>接触面が大きいほど流せる電流も増えます</b>。そのためクリーンな新品は慣らし後に空転電流が<b>上がる</b>ことが多く、汚れた個体や長期保管品では汚れが取れて電流が<b>下がる</b>効果の方が大きいこともあります。<b>どちらも正常</b>なので、この項目だけでは慣らしの効果を説明できません。</div><p><b>④(推奨、Pro 限定)健康指紋を作成</b>:慣らし完了＝この個体のピーク状態——この時「AI スマートモーター健康管理」で<b>健康指紋</b>を作れば、以後の定期検査で変化が分かります(「十二、AI 健康管理」参照)。</p><div class='manual-note'><b>測定条件(自動処理)</b>:慣らし前／後の測定条件はシステムが自動で揃えます——手動の待機や設定は不要;結果ページの「測定温度」で確認できます。慣らし直後は数分待ってから慣らし後測定を行い、あとはシステムに任せてください。</div>"
            )},
            {"id": "torque", "t": "八、AI トルク予測システム(Pro)", "html": (
                "<p class='manual-intro'><b>タミヤ公式規格を基準</b>に、このモーターのトルクを推算し、公式標準と<b>同じ図上に描画</b>します。<br><b>測定誤差:&#177;10%</b><br>「この個体は公式標準とどれだけ違うか」に答えます——<b>2 本の線の高低を見るだけ、スコアの解読は不要</b>。</p><p><b>操作</b>:ホーム →「AI トルク予測システム」→ <b>型番</b>選択(タミヤ全 15 種;型番を正しく選ばないと基準がずれます)+ <b>備考</b>(任意、40 字以内)→「予測開始」→ 全自動、画面は「<b>データ収集中</b>」と進捗のみ表示(途中でモーターに触れない)→ 約 <b>90 秒</b>で結果ページを表示。</p><p><b>結果ページの見方</b>:</p><table class='manual-table'><thead><tr><th>項目</th><th>意味</th><th>判読</th></tr></thead><tbody><tr><td><b>トルク予測図</b></td><td>2 本の線:明るい方が<b>タミヤ公式標準品</b>、もう 1 本が<b>この個体</b>。横軸は回転数、縦軸はトルク。各線はそのモーターの<b>2 つのテスト電圧での動作点</b>を結んだもの</td><td><b>標準線より下＝力が標準より小さい</b>——2 本の高低を見るだけ</td></tr><tr><td><b>予測トルク</b>(図の下)</td><td>テスト電圧ごとに予測最大トルクを 1 つずつ</td><td>例:「2.4V 7.59 mN·m／3.0V 9.71 mN·m」。<b>数字が大きいほど力が強い</b></td></tr><tr><td><b>測定温度の範囲</b></td><td>2 つのテスト電圧それぞれの測定期間の平均回転数(rpm)</td><td>参考用;同一個体の前後対照でより意味を持ちます</td></tr><tr><td><b>測定温度帯</b></td><td>今回の測定中の温度帯</td><td>同じ個体を日や季節をまたいで比較する際に併せて確認——温度差が大きいほど数値の比較可能性は下がります</td></tr></tbody></table><p><b>必ず知っておくこと</b>:</p><ul><li><b>これは「参考値」でトルク計の実測ではありません</b>——用途は<b>比較</b>(個体間、同一個体の長期変化)。線の相対的な高低を見るもので、<b>絶対値を計器レベルの精度と考えないでください</b>。</li><li><b>トルクは生まれつきで慣らしでは変わりません</b>——<b>この数字で慣らしの効果を判断しないでください</b>(慣らし後はむしろ少し下がるのが普通です。理由は「七、標準慣らしフロー」の警告を参照)。慣らし効果は同章の<b>2 つのルート</b>で判読を。</li><li><b>タミヤ公式標準が基準</b>(実測トルク計の絶対値ではない);公式規格はプレイヤー共通の座標です。</li><li><b>同型番でも個体ごとに数値が違う＝正常</b>:個体差の反映で測定ミスではありません。</li><li><b>型番は必ず正しく</b>:誤った型番＝誤った基準で比較となり、数字が無意味になります。</li></ul><div class='manual-note'><b>注意</b>:全自動・モーターに触れない;測定が完了しない場合は取付と回転センサーの位置合わせを確認して再測定;高温時は自動中止。</div>"
            )},
            {"id": "test", "t": "九、モーターテスト", "html": (
                "<p class='manual-intro'>単段階のリアルタイム観察、<b>履歴に保存しません</b>。<br><b>測定誤差:&#177;1%(回転数)</b></p><p>ホーム →「モーターテストプログラム」→ <b>電圧(0.6~4.0V、既定 1V)/ 運転時間(10~600 秒、既定 60)/ 方向 / 安定電流公差(2~50mA)/ 判定基準</b>(純時間制限 または スマート安定＝電流が早めに安定したら早期終了、既定は後者;この設定は慣らしページと<b>独立</b>)を設定 →「開始」→ リアルタイムデータと図表(<b>KV</b> 即時値含む)を見る、時間到達または安定で自動停止。</p><div class='manual-note'><b>注意</b>:上限 4.0V はモーター保護、迂回しない;逆転から正転へ切替前に一度「停止」を。本プログラムは<b>自動準備を一切行いません</b>——開始を押すと即開始、時間どおりに停止(条件を揃えた測定は特性測定／トルク予測を)。</div>"
            )},
            {"id": "records", "t": "十、履歴", "html": (
                "<p class='manual-intro'>各慣らしの完全データを自動保存、最大 <b>50 件</b>。</p><p>各件に 名前 / 開始時刻 / 時間 / モード / 終了理由 / 最大回転数 / 平均回転数 / 安定電流 を表示。</p><table class='manual-table'><thead><tr><th>ボタン</th><th>用途</th></tr></thead><tbody><tr><td>閲覧</td><td>各段階のデータを見る(複数回の記録は回ごとに各段階を列挙;一時停止設定と実際の待機秒数を含む)</td></tr><tr><td>適用</td><td>レシピ(<b>電圧／回転数モード</b>、回数、各回 10 段階パラメータ。電圧表と回転数表の両方と一時停止設定を復元)をワンタップで慣らしページへ戻し、慣らしページはその記録のモードへ自動で切り替わります;旧単回記録は適用後 回数=1</td></tr><tr><td>エクスポート</td><td>JSON(再インポート可)または CSV(Excel で開く)をダウンロード</td></tr><tr><td>削除</td><td>削除(復元不可)</td></tr></tbody></table><ul><li><b>平均RPM の前の「≈」</b>:その段階の回転数が安定判定に達しなかったため、運転末尾のローリング平均を記録しています(運転中に画面へ表示される平均回転数と同じ値)。</li><li><b>満杯(50 件)</b>:管理で「自動上書き」(開始時に最古を削除)または「上書きしない」(既定、開始がブロックされ手動整理)を選択。</li><li><b>インポート</b>:以前エクスポートした JSON を選択(id 重複は上書き)。JSON のみ。各エクスポートは<b>署名検証</b>付き:同一／同一ロット機器で相互運用可、改竄や別ロットのファイルは拒否;改名しても影響なし(内容を検証)。</li><li><b>ファイル名</b>:<code>motorlab_&lt;日付&gt;_&lt;時刻&gt;_&lt;型番&gt;[_&lt;備考&gt;]</code>、慣らし開始時刻を採用 → 同一件の再エクスポートは同じ名前。</li><li>ファーム更新 / WiFi リセットは<b>記録を消しません</b>。</li></ul>"
            )},
            ...
            {"id": "health", "t": "十二、AI スマートモーター健康管理(Pro)", "html": (
                "<p class='manual-intro'>モーターごとに<b>健康指紋</b>——慣らし完了時のピーク状態のスナップショット——を作成し、以後定期的に再測定し、<b>指紋からの変化</b>を見ます。<b>自分と比べ、他個体とは比べません</b>。<br><b>測定誤差:&#177;5%</b></p><p><b>正しい使用順序(重要)</b>:先にモーターを<b>慣らし完了</b>(AI スマート慣らしで自動停止まで推奨)させてから指紋を作成。指紋はこの個体の最良状態を表し、以後の各検査はそれと前回とを比べます。</p><ol><li>ホーム →「AI スマートモーター健康管理」→「+ モーター追加」。</li><li><b>型番</b>(プルダウン、必須——診断にはその型番の標準が必要)+ <b>備考</b>(任意)を入力。</li><li>確認 → 約 <b>7~8 分</b>で指紋を作成(特性測定 3 回 → ブラシ接触;各段の自動準備を含む)。「<b>まだ慣らし切れていない可能性</b>」と出たら内部損失がまだ高い状態——先に AI スマート慣らしを実行し、完了後に指紋を再作成してください。</li></ol><p>以後、各カードで:</p><ul><li><b>フル検査</b>:<b>磁力／内部損失／ブラシ接触</b>の 3 面を指紋と比較、最も完全。</li><li><b>クイック検査</b>:内部損失のみ比較、日常の速篩に。</li></ul><p>結果ページには<b>指紋からの変化</b>が並びます。各項目に 4 つ:現在値、指紋に対する変化率、<b>測定誤差の帯</b>、そして帯の内か外か。<b>帯の内＝測定そのものの再現性であってモーターが変わったわけではありません;帯の外に出て初めて、測定誤差では説明できない範囲です。</b>2 回続けて帯の外に出たときに、はじめて本当の変化として扱うことをおすすめします。<b>システムは数値と変化を示すだけで、採点も、交換すべきかの判断も行いません</b>——ご自身の使用感と照らして判断してください。結果にはその回の測定温度が付きます。</p><div class='manual-note'>機器はどれだけ変化したかだけを伝え、判読はご自身で。磁力は温度校正済みで季節をまたぐ比較も比較的信頼できますが、内部損失とブラシ安定度は未校正のため、できるだけ近い温度で比較してください。<b>±2% 以内の変化は多くが測定ばらつきで、モーターが本当に変わったわけではありません。</b></div><p>モーターカードには最新の検査時刻を表示(指紋のみで未検査の場合は「指紋作成済み + 時刻」)。詳細ページでは過去の検査と、<b>測定変化のトレンド図</b>を確認できます——<b>起点は指紋を作成した回</b>で、各項目はそれを 100% とするため、検査回数が増えても前へずれません。図の下に「このグラフの読み方」を掲載しています。</p><p><b>方向の読み方</b>:電流と回転数が<b>一緒に</b>上がるのは、摩耗にともなって接触面が広がっている様子です——片方だけ動いても該当しません。したがって回転数だけを見てはいけません:慣らしで滑らかになれば上がり、摩耗しても上がるので、電流と併せて読みます。磁力の低下と内耗の上昇は損失が増える方向;数値が跳ね始め、ばらつきが大きくなるのは接触が不安定なサインです。</p><p><b>指紋を再作成する時</b>:モーター洗浄／深いメンテ後、または検査で「指紋より滑らか」と出た時——新状態を新基準に。旧指紋は履歴に残り、このモーターの生涯履歴になります。</p><div class='manual-note'><b>注意</b>:各個体最大 50 回履歴、機器全体で最大 20 個;検査中は電源を切らない／他ボタンを押さない;高温時は自動中止;旧版で作成した指紋は一度の再作成が必要;M1 版はボタングレー(タップで升級案内)。</div>"
            )},
            {"id": "bearing", "t": "十三、ベアリング抵抗テスト", "html": (
                "<p class='manual-intro'>ベアリングの滑らかさを測定、どの版でも可。<b>完全停止までの時間が長いほど → ベアリングが滑らか</b>。<br><b>測定誤差:&#177;10%</b></p><p>ホーム →「ベアリング抵抗テスト」→ テスト電圧選択(<b>2.4V または 3V</b>)→「テスト開始」→ 機器がその電圧まで加速 → 安定回転 5 秒 → <b>直接電源断(ブレーキなし)</b> → 完全停止まで計時 → <b>完全停止時間</b>(小数第 2 位)と<b>測定温度</b>を表示。</p><div class='manual-note'><b>注意</b>:無負荷慣性が小さいため、本テストは<b>時間のみ表示</b>、同一個体の時期別や別個体の時間を互いに比較してください;回転センサー正常が必要;再現性は 2~3 回。温度が低いとオイルが粘く時間が短めに出ます——システムは必要に応じて<b>自動準備してから測定</b>します;温度が低すぎるか高すぎる場合は「データは参考のみ」と表示します。</div>"
            )},
            {"id": "brush", "t": "十四、ブラシ接触安定テスト", "html": (
                "<p class='manual-intro'>ブラシと整流子の接触が安定しているかを見ます。<b>どの版でも使用可</b>。測定した電流波形を 1 枚の図にし、<b>波形が安定＝接触が安定</b>です。<br><b>相対比較のためのツールで、絶対誤差は設けません。</b></p><p><b>操作</b>:ホーム →「ブラシ接触安定テスト」→「テスト開始」→ <b>全自動</b>(自動準備を含む)、途中は「<b>データ収集中</b>」と進捗のみ表示 → 完了で散布図を表示。</p><p><b>結果ページの見方</b>:</p><table class='manual-table'><thead><tr><th>要素</th><th>意味</th></tr></thead><tbody><tr><td><b>散布曲線</b></td><td>運転中の電流の推移。<b>滑らかなほどブラシ接触が安定</b>;起伏が大きい＝接触が跳ねている</td></tr><tr><td><b>平滑</b></td><td>スライダーで曲線の滑らかさ(1~10 段)を調整。見た目の細かさだけが変わり、データは変わりません</td></tr><tr><td><b>生データ雲</b></td><td>オンにすると元データの分布範囲を表示、オフにすると曲線のみ</td></tr></tbody></table><p><b>使い方</b>:</p><ul><li><b>同一個体の時期違い</b>で比較——メンテ前後・慣らし前後、曲線が平らになれば接触が良くなった証拠。</li><li><b>同型番の別個体</b>で比較——接触の安定した個体を実戦投入。</li><li><b>絶対値は見ないこと</b>。相対比較のツールで、機器や治具の保持状態でも変わります。</li></ul><div class='manual-note'><b>注意</b>:「確定」で結果を閉じると今回の図形データはメモリから消去されます(容量が戻ります)。残したい場合は先にスクリーンショットを。</div>"
            )},
...
def main():
    ...
    # 韌體版號單一來源:母版用 __FW__ 佔位,建置時一律代入 MANUAL["fw"]。
    # (hero.badge 以前把版號寫死在翻譯字串裡,每次發版都漏改 —— 改成佔位符後不會再漏。)
    src_html = src_html.replace("__FW__", MANUAL["fw"])
