    ...
    "sections": {
        "zh": [
            ...
            {"id": "wifireset", "t": "十五、WiFi 重設(救援)", "html": (
                "<p class='manual-intro'><b>用途</b>:忘記 WiFi 名稱 / 密碼時,把熱點重設回 <code>MotorTester</code> / <code>12345678</code>。</p><p><b>做法</b>:把機器上的「WiFi 重設」接點短接 3.3V(或按對應按鈕)<b>持續 5 秒</b> → 嗶 10 聲 → 自動重啟。</p><p><b>只重設 WiFi 熱點名稱與密碼</b>,以下全部保留:磨合參數 / 各項校正與設定 / <b>Pro 授權</b> / 歷史紀錄 / 馬達指紋 / RGB 設定 / 已記憶外部 WiFi。</p>"
            )},
