...
MANUAL = {
    ...
    "i18n": {
        "zh": {
            ...
            "description": "MotorLab Mini 4WD® 馬達磨合機完整使用手冊 — 連線、馬達特性量測、磨合兩種模式、AI 智慧磨合、馬達測試、歷史紀錄、全球磨合資料庫、AI 健康管理、軸承/電刷測試、田宮馬達規格、系統設定、安全保護、WiFi 重設與常見問題。對應韌體 v3.6.0。",
            "keywords": "MotorLab 使用手冊, 馬達磨合機操作, 馬達磨合機說明書, MotorLab 教學, 馬達磨合機設定",
            "breadcrumb": "使用者手冊",
            "eyebrow": "Docs · 使用者手冊",
            "h1": "MotorLab 使用者手冊",
            "lead": "Mini 4WD® 馬達磨合機完整操作說明。對應韌體 v3.6.0。功能隨版本更新,新版可能多出未列選項。",
            "toc_label": "目錄",
            "fw_note": "本手冊適用 MotorLab v3.6.0 韌體(2026-08-05)。",
        },
        "en": {
            "title": "MotorLab User Manual: Motor Break-in Machine Guide | MotorLab",
            "description": "Complete user manual for the MotorLab Mini 4WD® motor break-in machine — connection, motor characterization, two-mode break-in, AI smart break-in, testing, history records, global database, AI health management, bearing/brush tests, Tamiya motor specs, system settings, safety, WiFi reset and FAQ. For firmware v3.6.0.",
            ...
            "lead": "Complete operating guide for the Mini 4WD® motor break-in machine. For firmware v3.6.0. Features evolve with each release; newer firmware may add options not listed here.",
            "toc_label": "Contents",
            "fw_note": "This manual applies to MotorLab firmware v3.6.0 (2026-08-05).",
        },
        "ja": {
            "title": "MotorLab ユーザーマニュアル:モーター慣らし機操作ガイド | MotorLab",
            "description": "MotorLab Mini 4WD® モーター慣らし機の完全ユーザーマニュアル — 接続、モーター特性測定、慣らし 2 モード、AI スマート慣らし、テスト、履歴記録、グローバルデータ庫、AI 健康管理、ベアリング/ブラシ測定、タミヤモーター規格、システム設定、安全保護、WiFi リセット、FAQ。ファームウェア v3.6.0 対応。",
            ...
            "lead": "Mini 4WD® モーター慣らし機の完全操作ガイド。ファームウェア v3.6.0 対応。機能はバージョンごとに更新され、新版では未記載の項目が増える場合があります。",
            "toc_label": "目次",
            "fw_note": "本マニュアルは MotorLab ファームウェア v3.6.0（2026-08-05）に対応します。",
        },
    },
    "sections": {
        "zh": [
            ...
            {"id": "test", "t": "九、馬達測試", "html": (
                "<p class='manual-intro'>單階段即時觀察,<b>不寫入紀錄</b>。</p><p>首頁 →「馬達測試程式」→ 設 <b>電壓(0.6~4.0V,預設 1V)/ 運轉時間(10~600 秒,預設 60)/ 方向 / 穩定電流容差(2~50mA)/ 判停標準</b>(純時間限制 或 智慧穩定＝電流提前穩定即提早結束,預設後者;此設定與磨合頁<b>各自獨立</b>)→「啟動」→ 看即時數據與圖表(含 <b>KV</b> 即時值),到時或穩定即自動停。</p><div class='manual-note'><b>注意</b>:電壓上限 4.0V 保護馬達,勿繞過;反轉接正轉前先按一次「停止」。</div>"
            )},
        ...
        "ja": [
            ...
            {"id": "bearing", "t": "十三、ベアリング抵抗テスト", "html": (
                "<p class='manual-intro'>ベアリングの滑らかさを測定、どの版でも可。<b>完全停止までの時間が長いほど → ベアリングが滑らか</b>。</p><p>ホーム →「ベアリング抵抗テスト」→ テスト電圧選択(<b>2.4V または 3V</b>)→「テスト開始」→ 機器がその電圧まで加速 → 安定回転 5 秒 → <b>直接電源断(ブレーキなし)</b> → 完全停止まで計時 → <b>完全停止時間</b>を表示。</p><div class='manual-note'><b>注意</b>:無負荷慣性が小さいため、本テストは<b>時間のみ表示・良否評定なし</b>、同一個体の時期別や別個体の時間を互いに比較してください;回転センサー正常が必要;再現性は 2~3 回。</div>"
            )},
