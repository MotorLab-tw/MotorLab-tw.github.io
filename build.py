...
MANUAL = {
    ...
    "sections": {
        ...
        "en": [
            ...
            {"id": "database", "t": "10. Global Break-in Database", "html": (
            ...
            {"id": "health", "t": "11. AI Motor Health Manager (Pro)", "html": (
                "<p class='manual-intro'>Build a health fingerprint for each motor, re-measure periodically to compare, and get a 0–100 score with advice. <b>Compare against itself, not other units.</b></p><ol><li>Home → &quot;AI Motor Health Manager&quot; → &quot;+ Add motor.&quot;</li><li>Fill <b>motor model</b> (dropdown) + <b>note</b> (optional) + <b>start voltage</b> + <b>voltage step</b> (auto 5 points).</li><li>Confirm → runs about <b>2.5 minutes</b> to build a baseline.</li></ol><p>Then each card can run a <b>full check</b> (about 2.5 min, most accurate) or a <b>quick check</b> (about 1.5 min, ±5%). The result page shows a score, grade (Optimal/Acceptable/Warning/Critical), a trend chart, five metrics and text advice.</p><div class='manual-note'><b>Note</b>: up to 50 records per motor, 20 motors per machine; during a check don't cut power / press other buttons; overheating auto-aborts; on M1 the button is greyed out (tapping prompts to upgrade).</div>"
            )},
            {"id": "bearing", "t": "12. Bearing Resistance Test", "html": (
            ...
            {"id": "brush", "t": "13. Brush Contact Stability Test", "html": (
            ...
            {"id": "tamiya", "t": "14. Tamiya Motor Specs", "html": (
            ...
            {"id": "wifireset", "t": "17. WiFi Reset (Rescue)", "html": (
        ...
        "ja": [
            ...
            {"id": "database", "t": "十、グローバル慣らしデータ庫", "html": (
            ...
            {"id": "health", "t": "十一、AI スマートモーター健康管理(Pro)", "html": (
                "<p class='manual-intro'>各モーターに健康指紋を作り、定期的に再測定して比較、0~100 点とアドバイスを提示。<b>自分と比べ、他個体とは比べません</b>。</p><ol><li>ホーム →「AI スマートモーター健康管理」→「+ モーター追加」。</li><li><b>型番</b>(プルダウン)+ <b>備考</b>(任意)+ <b>開始電圧</b> + <b>電圧間隔</b>(自動で 5 点)を入力。</li><li>確認 → 約 <b>2.5 分</b>で基準を作成。</li></ol><p>以後、各カードで <b>フル検査</b>(約 2.5 分、最精確)または <b>クイック検査</b>(約 1.5 分、±5%)。結果ページにスコア、等級(Optimal/Acceptable/Warning/Critical)、トレンド図、5 指標、文字アドバイスを表示。</p><div class='manual-note'><b>注意</b>:各個体最大 50 回履歴、機器全体で最大 20 個;検査中は電源を切らない／他ボタンを押さない;高温時は自動中止;M1 版はボタングレー(タップで升級案内)。</div>"
            )},
            {"id": "bearing", "t": "十二、ベアリング抵抗テスト", "html": (
            ...
            {"id": "wifireset", "t": "十七、WiFi リセット(レスキュー)", "html": (
